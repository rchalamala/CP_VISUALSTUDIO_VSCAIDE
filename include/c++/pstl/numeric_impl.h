...
_Tp __pattern_transform_reduce(
  ...
  return __internal::__except_handler([&]() {
    return __par_backend::__parallel_transform_reduce(
        ...
        [__first1, __first2, __binary_op1, __binary_op2, __is_vector](
...
_Tp __pattern_transform_reduce(_ExecutionPolicy&& __exec,
  ...
  return __internal::__except_handler([&]() {
    return __par_backend::__parallel_transform_reduce(
        ...
        __init, __binary_op,
        [__unary_op, __binary_op, __is_vector](
            _ForwardIterator __i, _ForwardIterator __j, _Tp __init) {
          return __internal::__brick_transform_reduce(
...
__brick_transform_scan(_ForwardIterator __first, _ForwardIterator __last,
  ...
  return __internal::__brick_transform_scan(
      __first, __last, __result, __unary_op, __init, __binary_op, _Inclusive(),
...
_OutputIterator __pattern_transform_scan(
    ...
    _OutputIterator __result, _UnaryOperation __unary_op, _Tp __init,
    _BinaryOperation __binary_op, _Inclusive, _IsVector __is_vector,
    /*is_parallel=*/std::false_type) noexcept {
  ...
  return __internal::__except_handler([&]() {
    __par_backend::__parallel_transform_scan(
        ...
        [__first, __unary_op, __binary_op](_DifferenceType __i,
          ...
          // Execute serial __brick_transform_reduce, due to the explicit SIMD
          // vectorization (reduction) requires a commutative operation for the
          // guarantee of correct scan.
          return __internal::__brick_transform_reduce(
              __first + __i, __first + __j, __init, __binary_op, __unary_op,
              /*__is_vector*/ std::false_type());
        },
        [__first, __unary_op, __binary_op, __result, __is_vector](
            _DifferenceType __i, _DifferenceType __j, _Tp __init) {
          return __internal::__brick_transform_scan(
...
_ForwardIterator2 __brick_adjacent_difference(
    _ForwardIterator1 __first, _ForwardIterator1 __last,
    _ForwardIterator2 __d_first, BinaryOperation __op,
    /*is_vector=*/std::true_type) noexcept {
...
_ForwardIterator2 __pattern_adjacent_difference(
    ...
    _BinaryOperation __op, _IsVector __is_vector,
    /*is_parallel=*/std::true_type) {
  _PSTL_ASSERT(__first != __last);
  typedef typename std::iterator_traits<_ForwardIterator1>::reference
      _ReferenceType1;
