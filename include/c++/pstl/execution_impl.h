...
template <typename _Tp>
inline _Tp __lazy_and(_Tp __a, std::true_type) {
  return __a;
}
...
template <typename _Tp>
inline _Tp __lazy_or(_Tp __a, std::false_type) {
  return __a;
}
...
auto __is_vectorization_preferred(_ExecutionPolicy&& __exec) -> decltype(
    __internal::__lazy_and(__exec.__allow_vector(),
...
template <typename _ExecutionPolicy, typename... _IteratorTypes>
auto __is_parallelization_preferred(_ExecutionPolicy&& __exec) -> decltype(
    __internal::__lazy_and(__exec.__allow_parallel(),
                           typename __internal::__is_random_access_iterator<
                               _IteratorTypes...>::type())) {
  return __internal::__lazy_and(
...
struct __prefer_unsequenced_tag {
  static constexpr bool value =
      __internal::__allow_unsequenced<policy>::value &&
...
struct __prefer_parallel_tag {
  static constexpr bool value =
      __internal::__allow_parallel<policy>::value &&
      __internal::__is_random_access_iterator<_IteratorTypes...>::value;
  typedef std::integral_constant<bool, value> type;
};
