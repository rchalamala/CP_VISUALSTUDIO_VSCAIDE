...
__pstl::__internal::__enable_if_execution_policy<_ExecutionPolicy, bool> any_of(
...
__pstl::__internal::__enable_if_execution_policy<_ExecutionPolicy, bool> all_of(
    _ExecutionPolicy&& __exec, _ForwardIterator __first,
...
find_end(_ExecutionPolicy&& __exec, _ForwardIterator1 __first,
  ...
  return std::find_end(std::forward<_ExecutionPolicy>(__exec), __first, __last,
                       __s_first, __s_last, __pstl::__internal::__pstl_equal());
}
...
// Implementation note: count and count_if call the pattern directly instead of
// calling std::transform_reduce so that we do not have to include <numeric>.
...
copy(_ExecutionPolicy&& __exec, _ForwardIterator1 __first,
  ...
  using namespace __pstl;
  const auto __is_vector = __internal::__is_vectorization_preferred<
      _ExecutionPolicy, _ForwardIterator1, _ForwardIterator2>(__exec);
...
transform(_ExecutionPolicy&& __exec, _ForwardIterator1 __first1,
  ...
  return __internal::__pattern_walk3(
      std::forward<_ExecutionPolicy>(__exec), __first1, __last1, __first2,
      __result,
      [__op](_Input1Type x, _Input2Type y, _OutputType z) mutable {
        z = __op(x, y);
      },
      __internal::__is_vectorization_preferred<
...
template <class _ExecutionPolicy, class _ForwardIterator, class _Tp>
__pstl::__internal::__enable_if_execution_policy<_ExecutionPolicy, void> fill(
    _ExecutionPolicy&& __exec, _ForwardIterator __first,
    _ForwardIterator __last, const _Tp& __value) {
  using namespace __pstl;
  __internal::__pattern_fill(
...
unique_copy(_ExecutionPolicy&& __exec, _ForwardIterator1 __first,
            _ForwardIterator1 __last, _ForwardIterator2 __result) {
  return std::unique_copy(__exec, __first, __last, __result,
                          __pstl::__internal::__pstl_equal());
}
...
__pstl::__internal::__enable_if_execution_policy<_ExecutionPolicy, void> sort(
...
template <class _ExecutionPolicy, class _ForwardIterator1,
          class _ForwardIterator2, class _BinaryPredicate>
__pstl::__internal::__enable_if_execution_policy<_ExecutionPolicy, bool> equal(
...
__pstl::__internal::__enable_if_execution_policy<_ExecutionPolicy, bool> equal(
  ...
  return std::equal(std::forward<_ExecutionPolicy>(__exec), __first1, __last1,
                    __first2, __pstl::__internal::__pstl_equal());
}
...
__pstl::__internal::__enable_if_execution_policy<_ExecutionPolicy, bool> equal(
    ...
    _ForwardIterator2 __last2) {
  return std::equal(std::forward<_ExecutionPolicy>(__exec), __first1, __last1,
                    __first2, __last2, __pstl::__internal::__pstl_equal());
}
...
partial_sort(_ExecutionPolicy&& __exec, _RandomAccessIterator __first,
  ...
  typedef
      typename iterator_traits<_RandomAccessIterator>::value_type _InputType;
  std::partial_sort(std::forward<_ExecutionPolicy>(__exec), __first, __middle,
...
is_sorted(_ExecutionPolicy&& __exec, _ForwardIterator __first,
  ...
  return __internal::__pattern_adjacent_find(
             std::forward<_ExecutionPolicy>(__exec), __first, __last,
             __internal::__reorder_pred<_Compare>(__comp),
             __internal::__is_parallelization_preferred<_ExecutionPolicy,
                                                        _ForwardIterator>(
                 __exec),
             __internal::__is_vectorization_preferred<_ExecutionPolicy,
...
inplace_merge(_ExecutionPolicy&& __exec, _BidirectionalIterator __first,
  ...
  typedef typename std::iterator_traits<_BidirectionalIterator>::value_type
      _InputType;
  std::inplace_merge(std::forward<_ExecutionPolicy>(__exec), __first, __middle,
                     __last, std::less<_InputType>());
}
...
set_symmetric_difference(_ExecutionPolicy&& __exec, _ForwardIterator1 __first1,
  ...
  return std::set_symmetric_difference(
      std::forward<_ExecutionPolicy>(__exec), __first1, __last1, __first2,
      __last2, __result, __pstl::__internal::__pstl_less());
}
