...
__pstl::__internal::__enable_if_execution_policy<_ExecutionPolicy, _Tp> reduce(
...
exclusive_scan(_ExecutionPolicy&& __exec, _ForwardIterator1 __first,
  ...
  return transform_exclusive_scan(
      std::forward<_ExecutionPolicy>(__exec), __first, __last, __result, __init,
...
exclusive_scan(_ExecutionPolicy&& __exec, _ForwardIterator1 __first,
  ...
  return transform_exclusive_scan(std::forward<_ExecutionPolicy>(__exec),
...
adjacent_difference(_ExecutionPolicy&& __exec, _ForwardIterator1 __first,
  ...
  if (__first == __last) return __d_first;
