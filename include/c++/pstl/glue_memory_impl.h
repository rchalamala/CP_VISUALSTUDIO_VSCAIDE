...
uninitialized_copy(_ExecutionPolicy&& __exec, _InputIterator __first,
  ...
  const auto __is_parallel = __internal::__is_parallelization_preferred<
      _ExecutionPolicy, _InputIterator, _ForwardIterator>(__exec);
  const auto __is_vector =
      __internal::__is_vectorization_preferred<_ExecutionPolicy, _InputIterator,
      ...
      [&]() {
        return __internal::__pattern_walk2_brick(
            ...
            [__is_vector](_InputIterator __begin, _InputIterator __end,
              ...
              return __internal::__brick_copy(__begin, __end, __res,
                                              __is_vector);
            },
            __is_parallel);
      },
      ...
      [&]() {
        return __internal::__pattern_walk2_brick_n(
            ...
            [__is_vector](_InputIterator __begin, _Size __sz,
                          _ForwardIterator __res) {
              return __internal::__brick_copy_n(__begin, __sz, __res,
                                                __is_vector);
            },
            __is_parallel);
      },
      ...
      [&]() {
        __internal::__pattern_walk_brick(
            ...
            [&__value, &__is_vector](_ForwardIterator __begin,
              ...
              __internal::__brick_fill(__begin, __end, _ValueType(__value),
                                       __is_vector);
            },
            __is_parallel);
      },
      ...
      [&]() {
        return __internal::__pattern_walk_brick_n(
            ...
            [&__value, &__is_vector](_ForwardIterator __begin, _Size __count) {
              return __internal::__brick_fill_n(
      ...
      [&]() {
        __internal::__pattern_walk_brick(
            ...
            [__is_vector](_ForwardIterator __begin, _ForwardIterator __end) {
              __internal::__brick_fill(__begin, __end, _ValueType(),
                                       __is_vector);
            },
            __is_parallel);
      },
      ...
      [&]() {
        return __internal::__pattern_walk_brick_n(
            ...
            [__is_vector](_ForwardIterator __begin, _Size __count) {
              return __internal::__brick_fill_n(__begin, __count, _ValueType(),
                                                __is_vector);
            },
            __is_parallel);
      },
