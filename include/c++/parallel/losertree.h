...
class _LoserTreeBase {
 ...
 public:
   ...
   */
  _LoserTreeBase(unsigned int __k, _Compare __comp) : _M_comp(__comp) {
    _M_ik = __k;
   ...
   */
  int __get_min_source() { return _M_losers[0]._M_source; }
};
...
class _LoserTree : public _LoserTreeBase<_Tp, _Compare> {
 ...
 public:
  ...
  void __init() { _M_losers[0] = _M_losers[__init_winner(1)]; }
  ...
  void __delete_min_insert(_Tp __key, bool __sup) {
    ...
    for (unsigned int __pos = (_M_k + __source) / 2; __pos > 0; __pos /= 2) {
...
class _LoserTreePointerBase {
 ...
 public:
  ...
  ~_LoserTreePointerBase() { delete[] _M_losers; }
...
class _LoserTreePointerUnguardedBase {
 ...
 public:
  ...
  ~_LoserTreePointerUnguardedBase() { delete[] _M_losers; }
