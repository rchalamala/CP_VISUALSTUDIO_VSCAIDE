...
#undef _DEFINE_DECIMAL_COMPOUND_ASSIGNMENTS
  ...
  static decimal32 make_decimal32(long long __coeff, int __exponent) {
    ...
    for (int __i = 0; __i < __exponent; ++__i) __decexp *= __multiplier;
  ...
  static decimal128 make_decimal128(unsigned long long __coeff,
                                    int __exponent) {
    decimal128 __decexp = 1, __multiplier;
  ...
  inline float decimal_to_float(decimal32 __d) { return (float)__d.__getval(); }

  inline float decimal_to_float(decimal64 __d) { return (float)__d.__getval(); }
