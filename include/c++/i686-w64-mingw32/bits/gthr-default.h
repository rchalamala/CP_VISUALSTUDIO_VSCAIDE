...
int __gthread_objc_close_thread_system(void) {
  if (__gthread_objc_data_tls != (DWORD)-1) TlsFree(__gthread_objc_data_tls);
  return 0;
}
...
objc_thread_t __gthread_objc_thread_detach(void (*func)(void *arg), void *arg) {
  DWORD thread_id = 0;
  HANDLE win32_handle;

  if (!(win32_handle = CreateThread(NULL, 0, (LPTHREAD_START_ROUTINE)func, arg,
                                    0, &thread_id)))
    thread_id = 0;
...
void __gthread_objc_thread_yield(void) { Sleep(0); }
...
int __gthread_objc_condition_allocate(
    objc_condition_t ___GLIBCXX_UNUSED_PARAM(condition)) {
  /* Unimplemented.  */
  return -1;
}

/* Deallocate a condition.  */
int __gthread_objc_condition_deallocate(
    objc_condition_t ___GLIBCXX_UNUSED_PARAM(condition)) {
  /* Unimplemented.  */
  return -1;
}
...
int __gthread_objc_condition_wait(
    objc_condition_t ___GLIBCXX_UNUSED_PARAM(condition),
...
int __gthread_objc_condition_broadcast(
    objc_condition_t ___GLIBCXX_UNUSED_PARAM(condition)) {
  /* Unimplemented.  */
  return -1;
}
...
int __gthread_objc_condition_signal(
    objc_condition_t ___GLIBCXX_UNUSED_PARAM(condition)) {
  /* Unimplemented.  */
  return -1;
}
...
static inline long __gthr_i486_lock_cmp_xchg(long *__dest, long __xchg,
                                             long __comperand) {
  long result;
