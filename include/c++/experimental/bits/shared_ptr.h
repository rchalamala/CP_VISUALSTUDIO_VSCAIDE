...
namespace std _GLIBCXX_VISIBILITY(default) {
  ...
  class shared_ptr : public __shared_ptr<_Tp> {
   ...
   private:
    ...
    using _UniqCompatible =
        enable_if_t<__sp_compatible_v<_Tp1, _Tp> &&
   ...
   public:
    ...
    shared_ptr(_Tp1* __p, _Deleter __d) : _Base_type(__p, __d) {
      _M_enable_shared_from_this_with(__p);
    }
    ...
    shared_ptr(nullptr_t __p, _Deleter __d) : _Base_type(__p, __d) {}
    ...
    shared_ptr(const shared_ptr& __r) noexcept : _Base_type(__r) {}

    template <typename _Tp1, typename = _Compatible<_Tp1>>
    shared_ptr(const shared_ptr<_Tp1>& __r) noexcept : _Base_type(__r) {}

    shared_ptr(shared_ptr&& __r) noexcept : _Base_type(std::move(__r)) {}

    template <typename _Tp1, typename = _Compatible<_Tp1>>
    shared_ptr(shared_ptr<_Tp1>&& __r) noexcept : _Base_type(std::move(__r)) {}

    template <typename _Tp1, typename = _Compatible<_Tp1>>
    explicit shared_ptr(const weak_ptr<_Tp1>& __r) : _Base_type(__r) {}

#if _GLIBCXX_USE_DEPRECATED
    template <typename _Tp1, typename = _Compatible<_Tp1>>
    shared_ptr(std::auto_ptr<_Tp1>&& __r) : _Base_type(std::move(__r)) {
    ...
    shared_ptr(unique_ptr<_Tp1, _Del>&& __r) : _Base_type(std::move(__r)) {
    ...
    constexpr shared_ptr(nullptr_t __p) : _Base_type(__p) {}
    ...
    template <typename _Tp1>
    _Compatible<_Tp1, shared_ptr&> operator=(
    ...
    template <typename _Tp1>
    _Compatible<_Tp1, shared_ptr&> operator=(shared_ptr<_Tp1>&& __r) noexcept {
      _Base_type::operator=(std::move(__r));
      return *this;
    }
...
#if _GLIBCXX_USE_DEPRECATED
    template <typename _Tp1>
    _Compatible<_Tp1, shared_ptr&> operator=(std::auto_ptr<_Tp1>&& __r) {
    ...
    template <typename _Tp1, typename _Del>
    _UniqCompatible<_Tp1, _Del, shared_ptr&> operator=(
        unique_ptr<_Tp1, _Del>&& __r) {
      _Base_type::operator=(std::move(__r));
      return *this;
    }
   ...
   private:
    ...
    _M_enable_shared_from_this_with(const _Yp* __p) noexcept {
      if (auto __base = __expt_enable_shared_from_this_base(__p)) {
        __base->_M_weak_this = shared_ptr<_Yp>(*this, const_cast<_Yp*>(__p));
      }
    }
  ...
  class weak_ptr : public __weak_ptr<_Tp> {
   ...
   public:
    ...
    template <typename _Tp1, typename = _Compatible<_Tp1>>
    weak_ptr(const shared_ptr<_Tp1>& __r) noexcept : _Base_type(__r) {}

    weak_ptr(const weak_ptr&) noexcept = default;

    template <typename _Tp1, typename = _Compatible<_Tp1>>
    weak_ptr(const weak_ptr<_Tp1>& __r) noexcept : _Base_type(__r) {}

    weak_ptr(weak_ptr&&) noexcept = default;

    template <typename _Tp1, typename = _Compatible<_Tp1>>
    weak_ptr(weak_ptr<_Tp1>&& __r) noexcept : _Base_type(std::move(__r)) {}

    weak_ptr& operator=(const weak_ptr& __r) noexcept = default;

    template <typename _Tp1>
    _Compatible<_Tp1, weak_ptr&> operator=(const weak_ptr<_Tp1>& __r) noexcept {
      this->_Base_type::operator=(__r);
      return *this;
    }

    template <typename _Tp1>
    _Compatible<_Tp1, weak_ptr&> operator=(
        const shared_ptr<_Tp1>& __r) noexcept {
      this->_Base_type::operator=(__r);
      return *this;
    }
    ...
    template <typename _Tp1>
    _Compatible<_Tp1, weak_ptr&> operator=(weak_ptr<_Tp1>&& __r) noexcept {
  ...
  class owner_less<void> {
    ...
    bool operator()(shared_ptr<_Tp> const& __lhs,
    ...
    template <typename _Tp, typename _Up>
    bool operator()(weak_ptr<_Tp> const& __lhs,
                    shared_ptr<_Up> const& __rhs) const {
      return __lhs.owner_before(__rhs);
    }
  ...
  template <typename _Tp>
  shared_ptr<_Tp> atomic_store_explicit(const shared_ptr<_Tp>* __p,
                                        shared_ptr<_Tp> __r,
                                        memory_order __mo) {
  ...
  template <typename _Tp>
  shared_ptr<_Tp> atomic_exchange_explicit(const shared_ptr<_Tp>* __p,
                                           shared_ptr<_Tp> __r,
                                           memory_order __mo) {
  ...
  template <typename _Tp>
  bool atomic_compare_exchange_weak(shared_ptr<_Tp>* __p, shared_ptr<_Tp>* __v,
                                    shared_ptr<_Tp> __w) {
  ...
  bool atomic_compare_exchange_weak_explicit(shared_ptr<_Tp>* __p,
    ...
    return std::atomic_compare_exchange_weak_explicit<_Tp>(
        __p, __v, __w, __success, __failure);
  }
  ...
  bool atomic_compare_exchange_strong_explicit(shared_ptr<_Tp>* __p,
                                               ...
                                               memory_order __success,
                                               memory_order __failure) {
    return std::atomic_compare_exchange_strong_explicit<_Tp>(
        __p, __v, __w, __success, __failure);
  }
