...
namespace __gnu_cxx _GLIBCXX_VISIBILITY(default) {
  ...
  struct __pool_base {
    ...
    struct _Tune {
      ...
      explicit _Tune(size_t __align, size_t __maxb, size_t __minbin,
    ...
    const _Tune& _M_get_options() const { return _M_options; }
    ...
    size_t _M_get_binmap(size_t __bytes) { return _M_binmap[__bytes]; }

    size_t _M_get_align() { return _M_options._M_align; }
  ...
  class __pool<false> : public __pool_base {
   public:
    ...
    void _M_initialize_once() {
      if (__builtin_expect(_M_init == false, false)) _M_initialize();
    }
    ...
    explicit __pool() : _M_bin(0), _M_bin_size(1) {}
  ...
  class __pool<true> : public __pool_base {
   public:
    ...
    void _M_adjust_freelist(const _Bin_record& __bin, _Block_record* __block,
                            size_t __thread_id) {
    ...
    explicit __pool() : _M_bin(0), _M_bin_size(1), _M_thread_freelist(0) {}
  ...
  struct __common_pool_base<_PoolTp, true>
    ...
    static void _S_initialize() { _S_get_pool()._M_initialize_once(); }
  ...
  struct __per_type_pool {
    ...
    static pool_type& _S_get_pool() {
      ...
      const static size_t __a =
          (__alignof__(_Tp) >= sizeof(_Block_record) ? __alignof__(_Tp)
      ...
      static _Tune _S_tune(__a, sizeof(_Tp) * 64,
                           ...
                           _Tune::_S_max_threads, _Tune::_S_freelist_headroom,
...
#define __thread_default false
  ...
  __mt_alloc<_Tp, _Poolp>::allocate(size_type __n, const void*) {
  ...
  template <typename _Tp, typename _Poolp>
  void __mt_alloc<_Tp, _Poolp>::deallocate(pointer __p, size_type __n) {
  ...
  template <typename _Tp, typename _Poolp>
  inline bool operator==(const __mt_alloc<_Tp, _Poolp>&,
