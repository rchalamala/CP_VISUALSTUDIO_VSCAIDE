...
namespace __gnu_cxx _GLIBCXX_VISIBILITY(default) {
  ...
  void _Rope_iterator_base<_CharT, _Alloc>::_S_setcache(
    ...
    // Copy last section of path into _M_path_end.
    {
      ...
      if (__j < 0) __j = 0;
      while (__j <= __curr_depth) __x._M_path_end[++__i] = __path[__j++];
  ...
  void _Rope_iterator_base<_CharT, _Alloc>::_S_setcache_for_incr(
    ...
    while (--__current_index >= 0) {
      if (!(__dirns & 1) /* Path turned left */) break;
  ...
  template <class _CharT, class _Alloc>
  void _Rope_iterator_base<_CharT, _Alloc>::_M_incr(std::size_t __n) {
    _M_current_pos += __n;
    if (0 != _M_buf_ptr) {
  ...
  template <class _CharT, class _Alloc>
  void _Rope_iterator_base<_CharT, _Alloc>::_M_decr(std::size_t __n) {
    if (0 != _M_buf_ptr) {
  ...
  inline _Rope_iterator<_CharT, _Alloc>::_Rope_iterator(
      rope<_CharT, _Alloc> & __r, std::size_t __pos)
  ...
  template <class _CharT, class _Alloc>
  inline std::size_t rope<_CharT, _Alloc>::_S_char_ptr_len(const _CharT* __s) {
  ...
  inline void _Rope_RopeRep<_CharT, _Alloc>::_S_free_string(
      _CharT * __s, std::size_t __n, allocator_type & __a) {
    if (!_S_is_basic_char_type((_CharT*)0)) std::_Destroy(__s, __s + __n, __a);
  ...
  void _Rope_RopeRep<_CharT, _Alloc>::_M_free_tree() {
    switch (_M_tag) {
      ...
      case __detail::_S_concat: {
        ...
        __c->_Rope_RopeConcatenation<_CharT,
                                     _Alloc>::~_Rope_RopeConcatenation();
      ...
      case __detail::_S_substringfn: {
        ...
        __ss->_Rope_RopeSubstring<_CharT, _Alloc>::~_Rope_RopeSubstring();
  ...
  rope<_CharT, _Alloc>::_S_leaf_concat_char_iter(
      _RopeLeaf * __r, const _CharT* __iter, std::size_t __len) {
    std::size_t __old_len = __r->_M_size;
    _CharT* __new_data =
        (_CharT*)rope::_Data_allocate(_S_rounded_up_size(__old_len + __len));
    _RopeLeaf* __result;
  ...
  template <class _CharT, class _Alloc>
  typename rope<_CharT, _Alloc>::_RopeRep* rope<_CharT, _Alloc>::_S_tree_concat(
      _RopeRep * __left, _RopeRep * __right) {
    using std::size_t;
    _RopeConcatenation* __result =
        _S_new_RopeConcatenation(__left, __right, __left->_M_get_allocator());
  ...
  rope<_CharT, _Alloc>::_S_concat_char_iter(_RopeRep * __r, const _CharT* __s,
                                            std::size_t __slen) {
    using std::size_t;
    _RopeRep* __result;
    if (0 == __slen) {
  ...
  rope<_CharT, _Alloc>::_S_destr_concat_char_iter(
      _RopeRep * __r, const _CharT* __s, std::size_t __slen) {
    using std::size_t;
    _RopeRep* __result;
    if (0 == __r)
      return __STL_ROPE_FROM_UNOWNED_CHAR_PTR(__s, __slen,
  ...
  template <class _CharT, class _Alloc>
  typename rope<_CharT, _Alloc>::_RopeRep* rope<_CharT, _Alloc>::_S_concat(
      _RopeRep * __left, _RopeRep * __right) {
    using std::size_t;
    if (0 == __left) {
      _S_ref(__right);
    ...
    if (__detail::_S_leaf == __right->_M_tag) {
      if (__detail::_S_leaf == __left->_M_tag) {
        ...
        if (__leftright->_M_size + __right->_M_size <= size_t(_S_copy_max)) {
          ...
          _RopeRep* __rest = _S_leaf_concat_char_iter(
              __leftright, ((_RopeLeaf*)__right)->_M_data, __right->_M_size);
  ...
  template <class _CharT, class _Alloc>
  typename rope<_CharT, _Alloc>::_RopeRep* rope<_CharT, _Alloc>::_S_substring(
      _RopeRep * __base, std::size_t __start, std::size_t __endp1) {
    using std::size_t;
    ...
    switch (__base->_M_tag) {
      ...
      case __detail::_S_leaf: {
        ...
        __result = __STL_ROPE_FROM_UNOWNED_CHAR_PTR(
            __l->_M_data + __start, __result_len, __base->_M_get_allocator());
#endif
        return __result;
      }
      case __detail::_S_substringfn:
        // Avoid introducing multiple layers of substring nodes.
        {
          ...
          if (__result_len > __lazy_threshold) {
            _RopeSubstring* __result = _S_new_RopeSubstring(
                __old->_M_base, __start + __old->_M_start,
                __adj_endp1 - __start, __base->_M_get_allocator());
            return __result;
      ...
      case __detail::_S_function: {
        ...
        if (__result_len > __lazy_threshold) goto lazy;
        __section =
            (_CharT*)rope::_Data_allocate(_S_rounded_up_size(__result_len));
        __try {
  ...
  class _Rope_flatten_char_consumer : public _Rope_char_consumer<_CharT> {
   ...
   public:
    _Rope_flatten_char_consumer(_CharT* __buffer) { _M_buf_ptr = __buffer; }
  ...
  class _Rope_find_char_char_consumer : public _Rope_char_consumer<_CharT> {
   ...
   public:
    ...
    _Rope_find_char_char_consumer(_CharT __p) : _M_pattern(__p), _M_count(0) {}
  ...
  class _Rope_insert_char_consumer : public _Rope_char_consumer<_CharT> {
   ...
   public:
    _Rope_insert_char_consumer(_Insert_ostream& __writer) : _M_o(__writer) {}
  ...
  bool rope<_CharT, _Alloc>::_S_apply_to_pieces(
      _Rope_char_consumer<_CharT> & __c, const _RopeRep* __r,
    ...
    switch (__r->_M_tag) {
      case __detail::_S_concat: {
        ...
        if (__end > __left_len) {
          ...
          if (!_S_apply_to_pieces(__c, __right, __right_start - __left_len,
                                  __end - __left_len))
            return false;
        }
      }
      ...
      case __detail::_S_substringfn: {
        ...
        bool __result;
        _CharT* __buffer = (_CharT*)_Alloc().allocate(__len * sizeof(_CharT));
        __try {
  ...
  template <class _CharT, class _Traits>
  inline void _Rope_fill(std::basic_ostream<_CharT, _Traits> & __o,
                         std::size_t __n) {
    char __f = __o.fill();
    std::size_t __i;
  ...
  std::basic_ostream<_CharT, _Traits>& operator<<(
    ...
    __try {
      if (__is_simple && !__left && __pad_len > 0) _Rope_fill(__o, __pad_len);
      __r.apply_to_pieces(0, __r.size(), __c);
      if (__is_simple && __left && __pad_len > 0) _Rope_fill(__o, __pad_len);
      if (!__is_simple) __o.width(__w);
    }
    __catch(...) {
      if (!__is_simple) __o.width(__w);
      __throw_exception_again;
  ...
  template <class _CharT, class _Alloc>
  _CharT* rope<_CharT, _Alloc>::_S_flatten(_RopeRep * __r, std::size_t __start,
                                           std::size_t __len,
                                           _CharT * __buffer) {
  ...
  template <class _CharT, class _Alloc>
  std::size_t rope<_CharT, _Alloc>::find(_CharT __pattern, std::size_t __start)
      const {
  ...
  template <class _CharT, class _Alloc>
  _CharT* rope<_CharT, _Alloc>::_S_flatten(_RopeRep * __r, _CharT * __buffer) {
  ...
  void rope<_CharT, _Alloc>::_S_dump(_RopeRep * __r, int __indent) {
    ...
    if (__detail::_S_concat == __r->_M_tag) {
      ...
      printf("Concatenation %p (depth = %d, len = %ld, %s balanced)\n", __r,
             __r->_M_depth, __r->_M_size, __r->_M_is_balanced ? "" : "not");
#else
      printf(
...
#ifdef __GC
      printf("%s %p (depth = %d, len = %ld) ", __kind, __r, __r->_M_depth,
             __r->_M_size);
#else
      printf("%s %p (rc = %ld, depth = %d, len = %ld) ", __kind, __r,
             __r->_M_ref_count, __r->_M_depth, __r->_M_size);
#endif
  ...
  template <class _CharT, class _Alloc>
  const unsigned long
      rope<_CharT, _Alloc>::_S_min_len[int(__detail::_S_max_rope_depth) + 1] = {
          /* 0 */ 1,           /* 1 */ 2,           /* 2 */ 3,
          /* 3 */ 5,           /* 4 */ 8,           /* 5 */ 13,
          /* 6 */ 21,
          /* 7 */ 34,          /* 8 */ 55,          /* 9 */ 89,
          /* 10 */ 144,        /* 11 */ 233,        /* 12 */ 377,
          /* 13 */ 610,        /* 14 */ 987,        /* 15 */ 1597,
          /* 16 */ 2584,       /* 17 */ 4181,
          /* 18 */ 6765,       /* 19 */ 10946,      /* 20 */ 17711,
          /* 21 */ 28657,      /* 22 */ 46368,
          /* 23 */ 75025,      /* 24 */ 121393,     /* 25 */ 196418,
          /* 26 */ 317811,
          /* 27 */ 514229,     /* 28 */ 832040,     /* 29 */ 1346269,
          /* 30 */ 2178309,
          /* 31 */ 3524578,    /* 32 */ 5702887,    /* 33 */ 9227465,
          /* 34 */ 14930352,
          /* 35 */ 24157817,   /* 36 */ 39088169,   /* 37 */ 63245986,
          /* 38 */ 102334155,
  ...
  template <class _CharT, class _Alloc>
  typename rope<_CharT, _Alloc>::_RopeRep* rope<_CharT, _Alloc>::_S_balance(
      _RopeRep * __r) {
  ...
  template <class _CharT, class _Alloc>
  _CharT rope<_CharT, _Alloc>::_S_fetch(_RopeRep * __r, size_type __i) {
  ...
  template <class _CharT, class _Alloc>
  _CharT* rope<_CharT, _Alloc>::_S_fetch_ptr(_RopeRep * __r, size_type __i) {
    ...
    if (__detail::_S_leaf == __left->_M_tag) {
      ...
      if (__detail::_S_leaf == __right->_M_tag) {
        ...
        return lexicographical_compare_3way(
            __l->_M_data, __l->_M_data + __left_len, __r->_M_data,
            __r->_M_data + __right_len);
      } else {
        const_iterator __rstart(__right, 0);
        const_iterator __rend(__right, __right_len);
        return lexicographical_compare_3way(
            __l->_M_data, __l->_M_data + __left_len, __rstart, __rend);
      }
    } else {
      ...
      if (__detail::_S_leaf == __right->_M_tag) {
        _RopeLeaf* __r = (_RopeLeaf*)__right;
        return lexicographical_compare_3way(__lstart, __lend, __r->_M_data,
                                            __r->_M_data + __right_len);
      } else {
        const_iterator __rstart(__right, 0);
        const_iterator __rend(__right, __right_len);
  ...
  template <class _CharT, class _Alloc>
  rope<_CharT, _Alloc>::rope(std::size_t __n, _CharT __c,
    ...
    if (0 == __rest)
      ...
      __uninitialized_fill_n_a(__rest_buffer, __rest, __c, _M_get_allocator());
      ...
      __catch(...) {
        _RopeRep::__STL_FREE_STRING(__rest_buffer, __rest, _M_get_allocator());
        __throw_exception_again;
      }
    }
    ...
    if (__exponent != 0) {
      ...
      __try {
        __base_leaf = _S_new_RopeLeaf(__base_buffer, __exponentiate_threshold,
                                      _M_get_allocator());
      }
      __catch(...) {
        _RopeRep::__STL_FREE_STRING(__base_buffer, __exponentiate_threshold,
                                    _M_get_allocator());
        __throw_exception_again;
      }
      ...
      if (1 == __exponent)
        ...
        __result =
            power(__base_rope, __exponent, _Rope_Concat_fn<_CharT, _Alloc>());

      if (0 != __remainder) __result += __remainder_rope;
    } else
  ...
  const _CharT* rope<_CharT, _Alloc>::replace_with_c_str() {
    ...
    if (__detail::_S_leaf == this->_M_tree_ptr->_M_tag && 0 != __old_c_string)
    ...
    this->_M_tree_ptr =
        _S_new_RopeLeaf(__result, __s, this->_M_get_allocator());
    return (__result);
  }
  ...
  void                             // VC++ workaround
  _Rope_rotate(_Rope_iterator __first, _Rope_iterator __middle,
  ...
  inline void rotate(
      _Rope_iterator<char, __STL_DEFAULT_ALLOCATOR(char)> __first,
