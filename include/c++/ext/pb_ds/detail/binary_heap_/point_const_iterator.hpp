...
class binary_heap_point_const_iterator_ {
 ...
 public:
  ...
  inline binary_heap_point_const_iterator_(entry_pointer p_e) : m_p_e(p_e) {}

  /// Default constructor.
  inline binary_heap_point_const_iterator_() : m_p_e(0) {}

  /// Copy constructor.
  inline binary_heap_point_const_iterator_(
  ...
  inline bool operator==(const binary_heap_point_const_iterator_& other) const {
 ...
 private:
  inline const_pointer to_ptr(true_type) const { return m_p_e; }

  inline const_pointer to_ptr(false_type) const { return *m_p_e; }
