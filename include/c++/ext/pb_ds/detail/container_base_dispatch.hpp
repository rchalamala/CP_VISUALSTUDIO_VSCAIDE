...
#define PB_DS_CHECK_KEY_DOES_NOT_EXIST(_Key) \
  _GLIBCXX_DEBUG_ONLY(                       \
      debug_base::check_key_does_not_exist(_Key, __FILE__, __LINE__);)
...
struct container_base_dispatch<Key, null_type, _Alloc, cc_hash_tag, Policy_Tl> {
 ...
 public:
  /// Dispatched type.
  typedef cc_ht_set<Key, null_type, at0t, at1t, _Alloc, at3t::value, at4t, at2t>
      type;
};
...
struct container_base_dispatch<Key, null_type, _Alloc, gp_hash_tag, Policy_Tl> {
 ...
 public:
  /// Dispatched type.
  typedef gp_ht_set<Key, null_type, at0t, at1t, _Alloc, at3t::value, at4t, at5t,
                    at2t>
      type;
};
}  // namespace detail
