...
PB_DS_CLASS_T_DEC
void PB_DS_CLASS_C_DEC::do_resize(size_type len) {
...
PB_DS_CLASS_T_DEC
void PB_DS_CLASS_C_DEC::resize_imp_no_exceptions(
    size_type new_size, entry_pointer_array a_p_entries_resized,
    size_type old_size) {
  ...
  for (size_type pos = 0; pos < old_size; ++pos) {
    ...
    while (p_e != 0)
      p_e = resize_imp_no_exceptions_reassign_pointer(
          p_e, a_p_entries_resized, traits_base::m_store_extra_indicator);
  }
