...
PB_DS_CLASS_T_DEC
inline bool PB_DS_CLASS_C_DEC::erase_in_pos_imp(
    key_const_reference r_key, const comp_hash& r_pos_hash_pair) {
  ...
  if (hash_eq_fn_base::operator()(PB_DS_V2F(p_e->m_value), p_e->m_hash, r_key,
