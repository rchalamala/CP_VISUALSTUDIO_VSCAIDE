...
PB_DS_CLASS_T_DEC
void PB_DS_CLASS_C_DEC::clear() { deallocate_all(); }
...
PB_DS_CLASS_T_DEC
void PB_DS_CLASS_C_DEC::erase_next(entry_pointer p_l) {
...
PB_DS_CLASS_T_DEC
void PB_DS_CLASS_C_DEC::actual_erase_entry(entry_pointer p_l) {
