...
struct no_throw_copies {
  static const bool __simple =
      is_simple<Key>::value && is_simple<Mapped>::value;
...
struct stored_data<_Tv, _Th, false> : public stored_value<_Tv> {};
...
template <typename Key, typename _Alloc, bool Store_Hash>
null_type maybe_null_type<Key, null_type, _Alloc, Store_Hash>::s_null_type;
...
template <typename Key, typename Mapped, typename _Alloc, bool Store_Hash>
struct types_traits : public maybe_null_type<Key, Mapped, _Alloc, Store_Hash> {
 public:
