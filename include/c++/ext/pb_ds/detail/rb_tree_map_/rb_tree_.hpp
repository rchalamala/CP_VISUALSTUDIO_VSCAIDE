...
class PB_DS_RB_TREE_NAME : public PB_DS_RB_TREE_BASE {
 ...
 public:
  ...
  inline mapped_reference operator[](key_const_reference r_key) {
    ...
    if (ins_pair.second == true) {
      ...
      _GLIBCXX_DEBUG_ONLY(
          this->structure_only_assert_valid(__FILE__, __LINE__);)
 ...
 private:
  ...
  size_type assert_node_consistent(const node_pointer, const char*, int) const;
#endif
  ...
  std::pair<node_pointer, node_pointer> find_join_pos_right(node_pointer,
                                                            size_type,
                                                            size_type);

  std::pair<node_pointer, node_pointer> find_join_pos_left(node_pointer,
                                                           size_type,
                                                           size_type);
