...
struct rb_tree_node_ {
 public:
  ...
  typedef typename rebind_traits<_Alloc, rb_tree_node_>::pointer node_pointer;
  ...
  bool special() const { return m_red; }

  metadata_const_reference get_metadata() const { return m_metadata; }

  metadata_reference get_metadata() { return m_metadata; }
