...
struct splay_tree_node_ {
 public:
  ...
  typedef
      typename rebind_traits<_Alloc, splay_tree_node_>::pointer node_pointer;
  ...
  inline bool special() const { return m_special; }

  inline metadata_const_reference get_metadata() const { return m_metadata; }

  inline metadata_reference get_metadata() { return m_metadata; }
...
#ifdef PB_DS_BIN_SEARCH_TREE_TRACE_
  void trace() const { std::cout << PB_DS_V2F(m_value); }
#endif
