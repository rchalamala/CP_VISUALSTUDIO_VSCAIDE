...
PB_DS_CLASS_T_DEC
PB_DS_CLASS_C_DEC::left_child_next_sibling_heap()
    : m_p_root(0),
      m_size(0){PB_DS_ASSERT_VALID((*this))}

      PB_DS_CLASS_T_DEC PB_DS_CLASS_C_DEC::left_child_next_sibling_heap(
...
PB_DS_CLASS_T_DEC
PB_DS_CLASS_C_DEC::~left_child_next_sibling_heap() { clear(); }
...
typename PB_DS_CLASS_C_DEC::node_pointer PB_DS_CLASS_C_DEC::recursive_copy_node(
  ...
  p_ret->m_p_l_child = p_ret->m_p_next_sibling = p_ret->m_p_prev_or_parent = 0;
  ...
  if (p_ret->m_p_l_child != 0) p_ret->m_p_l_child->m_p_prev_or_parent = p_ret;
