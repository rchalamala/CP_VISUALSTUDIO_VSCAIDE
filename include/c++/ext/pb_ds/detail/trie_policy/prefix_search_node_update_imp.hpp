...
PB_DS_CLASS_T_DEC
std::pair<typename PB_DS_CLASS_C_DEC::const_iterator,
          typename PB_DS_CLASS_C_DEC::const_iterator>
PB_DS_CLASS_C_DEC::prefix_range(key_const_reference r_key) const {
...
PB_DS_CLASS_C_DEC::prefix_range(key_const_reference r_key) {
...
std::pair<typename PB_DS_CLASS_C_DEC::const_iterator,
          typename PB_DS_CLASS_C_DEC::const_iterator>
PB_DS_CLASS_C_DEC::prefix_range(
...
std::pair<typename PB_DS_CLASS_C_DEC::iterator,
          typename PB_DS_CLASS_C_DEC::iterator>
PB_DS_CLASS_C_DEC::prefix_range(typename access_traits::const_iterator b,
  ...
  while (true) {
    if (nd_it == end_nd_it) return (std::make_pair(end(), end()));
...
PB_DS_CLASS_T_DEC
typename PB_DS_CLASS_C_DEC::node_iterator PB_DS_CLASS_C_DEC::next_child(
    node_iterator nd_it, typename access_traits::const_iterator b,
