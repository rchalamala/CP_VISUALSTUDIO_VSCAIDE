...
PB_DS_CLASS_T_DEC
inline typename PB_DS_CLASS_C_DEC::point_iterator PB_DS_CLASS_C_DEC::push(
...
PB_DS_CLASS_T_DEC
inline void PB_DS_CLASS_C_DEC::make_root(node_pointer p_nd) {
  p_nd->m_metadata =
      p_nd->m_p_l_child == 0 ? 0 : 1 + p_nd->m_p_l_child->m_metadata;
}

PB_DS_CLASS_T_DEC
inline void PB_DS_CLASS_C_DEC::make_root_and_link(node_pointer p_nd) {
  make_root(p_nd);
  p_nd->m_p_prev_or_parent = 0;
  p_nd->m_p_next_sibling = base_type::m_p_root;
  if (base_type::m_p_root != 0) base_type::m_p_root->m_p_prev_or_parent = 0;
...
PB_DS_CLASS_T_DEC
inline void PB_DS_CLASS_C_DEC::fix(node_pointer p_y) {
  while (true) {
    if (p_y->m_p_prev_or_parent == 0) {
      ...
      p_y = p_y->m_p_prev_or_parent;
    } else if ((p_y->m_p_l_child == 0 && p_y->m_metadata == 2) ||
               (p_y->m_p_l_child != 0 &&
...
PB_DS_CLASS_T_DEC
inline void PB_DS_CLASS_C_DEC::fix_root(node_pointer p_y) {
...
PB_DS_CLASS_T_DEC
inline void PB_DS_CLASS_C_DEC::fix_sibling_rank_1_unmarked(node_pointer p_y) {
  _GLIBCXX_DEBUG_ASSERT(p_y->m_p_prev_or_parent != 0);
...
PB_DS_CLASS_T_DEC
inline void PB_DS_CLASS_C_DEC::fix_sibling_rank_1_marked(node_pointer p_y) {
  _GLIBCXX_DEBUG_ASSERT(p_y->m_p_prev_or_parent != 0);
  _GLIBCXX_DEBUG_ASSERT(p_y->m_p_l_child == 0);
  p_y->m_metadata = 0;
  PB_DS_ASSERT_NODE_CONSISTENT(p_y, false)
...
PB_DS_CLASS_T_DEC
inline void PB_DS_CLASS_C_DEC::fix_sibling_general_unmarked(node_pointer p_y) {
  _GLIBCXX_DEBUG_ASSERT(p_y->m_p_prev_or_parent != 0);
...
PB_DS_CLASS_T_DEC
inline void PB_DS_CLASS_C_DEC::fix_sibling_general_marked(node_pointer p_y) {
  _GLIBCXX_DEBUG_ASSERT(p_y->m_p_prev_or_parent != 0);
  --p_y->m_metadata;
  PB_DS_ASSERT_NODE_CONSISTENT(p_y, false)
}
...
PB_DS_CLASS_T_DEC
inline void PB_DS_CLASS_C_DEC::fix_child(node_pointer p_y) {
  _GLIBCXX_DEBUG_ASSERT(p_y->m_p_prev_or_parent != 0);
...
PB_DS_CLASS_T_DEC
void PB_DS_CLASS_C_DEC::modify(point_iterator it, const_reference r_new_val) {
  PB_DS_ASSERT_VALID((*this))
...
PB_DS_CLASS_T_DEC
inline void PB_DS_CLASS_C_DEC::update_max(node_pointer p_nd) {
