...
PB_DS_CLASS_T_DEC
PB_DS_CLASS_C_DEC::ranged_hash_fn(size_type size) {
  Comb_Hash_Fn::notify_resized(size);
}

PB_DS_CLASS_T_DEC
PB_DS_CLASS_C_DEC::ranged_hash_fn(size_type size, const Hash_Fn& r_hash_fn)
    : Hash_Fn(r_hash_fn) {
  Comb_Hash_Fn::notify_resized(size);
}
...
class ranged_hash_fn<Key, Hash_Fn, _Alloc, Comb_Hash_Fn, true>
 ...
 protected:
  ...
  inline comp_hash operator()(key_const_reference, size_type) const;
};
...
PB_DS_CLASS_T_DEC
PB_DS_CLASS_C_DEC::ranged_hash_fn(size_type size, const null_type& r_null_type,
                                  const Comb_Hash_Fn& r_comb_hash_fn)
    : Comb_Hash_Fn(r_comb_hash_fn) {}
