 ...
 * Contains a unified ranged probe functor, allowing the probe tables to deal
 * with a single class for ranged probeing.
 */
...
class ranged_probe_fn<Key, Hash_Fn, _Alloc, Comb_Probe_Fn, Probe_Fn, false>
 ...
 protected:
  ...
  typedef
      typename rebind_traits<_Alloc, Key>::const_reference key_const_reference;
  ...
  inline size_type operator()(key_const_reference) const;

  inline size_type operator()(key_const_reference, size_type, size_type) const;
};

PB_DS_CLASS_T_DEC
PB_DS_CLASS_C_DEC::ranged_probe_fn(size_type size) {
  Comb_Probe_Fn::notify_resized(size);
}

PB_DS_CLASS_T_DEC
PB_DS_CLASS_C_DEC::ranged_probe_fn(size_type size, const Hash_Fn& r_hash_fn)
    : Hash_Fn(r_hash_fn) {
  Comb_Probe_Fn::notify_resized(size);
}
...
PB_DS_CLASS_T_DEC
void PB_DS_CLASS_C_DEC::notify_resized(size_type size) {
  comb_probe_fn_base::notify_resized(size);
}
...
PB_DS_CLASS_T_DEC
inline typename PB_DS_CLASS_C_DEC::size_type PB_DS_CLASS_C_DEC::operator()(
    key_const_reference, size_type hash, size_type i) const {
...
class ranged_probe_fn<Key, Hash_Fn, _Alloc, Comb_Probe_Fn, Probe_Fn, true>
 ...
 protected:
  ...
  inline comp_hash operator()(key_const_reference) const;

  inline size_type operator()(key_const_reference, size_type, size_type) const;

  inline size_type operator()(key_const_reference, size_type) const;
};
...
PB_DS_CLASS_T_DEC
inline typename PB_DS_CLASS_C_DEC::comp_hash PB_DS_CLASS_C_DEC::operator()(
    key_const_reference r_key) const {
...
class ranged_probe_fn<Key, null_type, _Alloc, Comb_Probe_Fn, null_type, false>
 ...
 protected:
  ...
  ranged_probe_fn(size_type size) { Comb_Probe_Fn::notify_resized(size); }
  ...
  ranged_probe_fn(size_type, const null_type&,
                  const Comb_Probe_Fn& r_comb_probe_fn, const null_type&)
      : Comb_Probe_Fn(r_comb_probe_fn) {}

  void swap(ranged_probe_fn& other) { comb_probe_fn_base::swap(other); }
};
}  // namespace detail
}  // namespace __gnu_pbds
