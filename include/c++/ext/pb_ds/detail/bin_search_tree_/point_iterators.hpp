...
class bin_search_tree_const_it_ {
 public:
  ...
  inline bin_search_tree_const_it_(const PB_DS_TREE_CONST_ODIR_IT_C_DEC& other)
      : m_p_nd(other.m_p_nd) {}
  ...
  inline bool operator==(const PB_DS_TREE_CONST_IT_C_DEC& other) const {
    return m_p_nd == other.m_p_nd;
  }

  inline bool operator==(const PB_DS_TREE_CONST_ODIR_IT_C_DEC& other) const {
    return m_p_nd == other.m_p_nd;
  }
  ...
  inline PB_DS_TREE_CONST_IT_C_DEC operator++(int) {
 ...
 protected:
  ...
  void inc(true_type) {
    ...
    if (m_p_nd->m_p_right != 0) {
      ...
      while (m_p_nd->m_p_left != 0) m_p_nd = m_p_nd->m_p_left;
      return;
    }
    ...
    if (m_p_nd->m_p_right != p_y) m_p_nd = p_y;
  }
  ...
  void dec(true_type) {
    ...
    if (m_p_nd->m_p_left != 0) {
      ...
      while (p_y->m_p_right != 0) p_y = p_y->m_p_right;
      m_p_nd = p_y;
      return;
    }
    ...
    if (m_p_nd->m_p_left != p_y) m_p_nd = p_y;
  }
...
class bin_search_tree_it_ : public PB_DS_TREE_CONST_IT_C_DEC {
 public:
  ...
  inline bin_search_tree_it_(const PB_DS_TREE_ODIR_IT_C_DEC& other)
      : PB_DS_TREE_CONST_IT_C_DEC(other.m_p_nd) {}

  inline PB_DS_TREE_IT_C_DEC& operator=(const PB_DS_TREE_IT_C_DEC& other) {
    base_it_type::m_p_nd = other.m_p_nd;
    return *this;
  }

  inline PB_DS_TREE_IT_C_DEC& operator=(const PB_DS_TREE_ODIR_IT_C_DEC& other) {
    base_it_type::m_p_nd = other.m_p_nd;
    return *this;
  }

  inline typename PB_DS_TREE_CONST_IT_C_DEC::pointer operator->() const {
    _GLIBCXX_DEBUG_ASSERT(base_it_type::m_p_nd != 0);
    return &base_it_type::m_p_nd->m_value;
  }

  inline typename PB_DS_TREE_CONST_IT_C_DEC::reference operator*() const {
    _GLIBCXX_DEBUG_ASSERT(base_it_type::m_p_nd != 0);
    return base_it_type::m_p_nd->m_value;
  }
  ...
  inline PB_DS_TREE_IT_C_DEC operator++(int) {
