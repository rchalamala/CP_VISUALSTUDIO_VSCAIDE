...
PB_DS_CLASS_T_DEC
PB_DS_CLASS_C_DEC::PB_DS_GP_HASH_NAME()
...
PB_DS_CLASS_T_DEC
PB_DS_CLASS_C_DEC::PB_DS_GP_HASH_NAME(const Hash_Fn& r_hash_fn)
...
PB_DS_CLASS_C_DEC::PB_DS_GP_HASH_NAME(const Hash_Fn& r_hash_fn,
                                      const Eq_Fn& r_eq_fn,
                                      const Comb_Probe_Fn& comb_hash_fn,
...
PB_DS_CLASS_T_DEC
PB_DS_CLASS_C_DEC::PB_DS_GP_HASH_NAME(const PB_DS_CLASS_C_DEC& other)
    :
...
PB_DS_CLASS_T_DEC
PB_DS_CLASS_C_DEC::~PB_DS_GP_HASH_NAME() { deallocate_all(); }
...
PB_DS_CLASS_T_DEC
void PB_DS_CLASS_C_DEC::erase_all_valid_entries(entry_array a_entries_resized,
                                                size_type len) {
  for (size_type pos = 0; pos < len; ++pos) {
    entry_pointer p_e = &a_entries_resized[pos];
    if (p_e->m_stat == valid_entry_status) p_e->m_value.~value_type();
  }
}
