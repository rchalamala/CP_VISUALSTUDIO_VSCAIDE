...
#define PB_DS_SIZE_BASE_C_DEC                                 \
  detail::hash_load_check_resize_trigger_size_base<Size_Type, \
...
class cc_hash_max_collision_check_resize_trigger {
 ...
 private:
  ...
  inline void calc_resize_needed();
...
#define PB_DS_CLASS_T_DEC                                  \
  template <typename Size_Policy, typename Trigger_Policy, \
            bool External_Size_Access, typename Size_Type>

#define PB_DS_CLASS_C_DEC                                  \
  hash_standard_resize_policy<Size_Policy, Trigger_Policy, \
                              External_Size_Access, Size_Type>
...
class hash_standard_resize_policy : public Size_Policy, public Trigger_Policy {
 public:
  ...
  inline size_type get_actual_size() const;
