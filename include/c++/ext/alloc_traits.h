...
namespace __gnu_cxx _GLIBCXX_VISIBILITY(default) {
...
#endif
  {
   ...
   public:
    ...
    _GLIBCXX_NODISCARD static pointer allocate(_Alloc& __a, size_type __n) {
    ...
    static void destroy(_Alloc& __a, pointer __p) { __a.destroy(__p); }

    static size_type max_size(const _Alloc& __a) { return __a.max_size(); }
