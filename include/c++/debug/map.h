...
namespace std _GLIBCXX_VISIBILITY(default) {
  ...
  class map : public __gnu_debug::_Safe_container<
   ...
   public:
    ...
    explicit map(const allocator_type& __a) : _Base(__a) {}

    map(const map& __m, const allocator_type& __a) : _Base(__m, __a) {}

    map(map&& __m, const allocator_type& __a) noexcept(
        noexcept(_Base(std::move(__m._M_base()), __a)))
    ...
    map(_InputIterator __first, _InputIterator __last,
        ...
        : _Base(__gnu_debug::__base(
                    __glibcxx_check_valid_constructor_range(__first, __last)),
                __gnu_debug::__base(__last), __comp, __a) {}
    ...
    iterator end() _GLIBCXX_NOEXCEPT { return iterator(_Base::end(), this); }
    ...
    iterator emplace_hint(const_iterator __pos, _Args&&... __args) {
      ...
      return {_Base::emplace_hint(__pos.base(), std::forward<_Args>(__args)...),
              this};
    }
#endif
    ...
    iterator insert(const_iterator __position, _Pair&& __x) {
      __glibcxx_check_insert(__position);
      return {_Base::insert(__position.base(), std::forward<_Pair>(__x)), this};
    }
#endif
    ...
    pair<iterator, bool> try_emplace(const key_type& __k, _Args&&... __args) {
      auto __res = _Base::try_emplace(__k, std::forward<_Args>(__args)...);
      return {{__res.first, this}, __res.second};
    }
    ...
    pair<iterator, bool> try_emplace(key_type&& __k, _Args&&... __args) {
      auto __res =
          _Base::try_emplace(std::move(__k), std::forward<_Args>(__args)...);
      return {{__res.first, this}, __res.second};
    }
    ...
    std::pair<iterator, bool> insert_or_assign(const key_type& __k,
                                               _Obj&& __obj) {
      auto __res = _Base::insert_or_assign(__k, std::forward<_Obj>(__obj));
      return {{__res.first, this}, __res.second};
    }
    ...
    std::pair<iterator, bool> insert_or_assign(key_type&& __k, _Obj&& __obj) {
      auto __res =
          _Base::insert_or_assign(std::move(__k), std::forward<_Obj>(__obj));
      return {{__res.first, this}, __res.second};
    }
    ...
    node_type extract(const key_type& __key) {
      ...
      if (__position != end()) return extract(__position);
      return {};
    }

    insert_return_type insert(node_type&& __nh) {
      auto __ret = _Base::insert(std::move(__nh));
      return {{__ret.position, this}, __ret.inserted, std::move(__ret.node)};
    }
    ...
    void erase(iterator __first, iterator __last) {
      ...
      // 151. can't currently clear() empty container
      __glibcxx_check_erase_range(__first, __last);
      for (_Base_iterator __victim = __first.base(); __victim != __last.base();
           ++__victim) {
...
#if __cplusplus > 201103L
    template <typename _Kt, typename _Req = typename __has_is_transparent<
                                _Compare, _Kt>::type>
    ...
    _Base& _M_base() _GLIBCXX_NOEXCEPT { return *this; }

    const _Base& _M_base() const _GLIBCXX_NOEXCEPT { return *this; }
  };
  ...
  map(_InputIterator, _InputIterator, _Compare = _Compare(),
  ...
  template <typename _Key, typename _Tp, typename _Compare = less<_Key>,
            ...
            typename = _RequireNotAllocator<_Compare>,
            typename = _RequireAllocator<_Allocator>>
  map(initializer_list<pair<_Key, _Tp>>, _Compare = _Compare(),
  ...
  inline bool operator==(const map<_Key, _Tp, _Compare, _Allocator>& __lhs,
  ...
  inline __detail::__synth3way_t<pair<const _Key, _Tp>> operator<=>(
      const map<_Key, _Tp, _Compare, _Alloc>& __lhs,
  ...
  template <typename _Key, typename _Tp, typename _Compare, typename _Allocator>
  inline void swap(map<_Key, _Tp, _Compare, _Allocator>& __lhs,
