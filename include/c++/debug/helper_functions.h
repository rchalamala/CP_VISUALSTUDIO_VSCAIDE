...
struct _Distance_traits {
 private:
  typedef typename std::iterator_traits<_Iterator>::difference_type _ItDiffType;
 ...
 */
template <typename _Iterator>
_GLIBCXX_CONSTEXPR inline typename _Distance_traits<_Iterator>::__type
...
template <typename _Iterator>
_GLIBCXX14_CONSTEXPR inline typename _Distance_traits<_Iterator>::__type
__get_distance(_Iterator __lhs, _Iterator __rhs, std::input_iterator_tag) {
  if (__lhs == __rhs) return std::make_pair(0, __dp_exact);
...
inline bool __check_singular(_Tp* const& __ptr) {
  return __ptr == 0;
}
 ...
 */
template <typename _Integral>
_GLIBCXX_CONSTEXPR inline bool __valid_range_aux(_Integral, _Integral,
                                                 std::__true_type) {
  return true;
}

template <typename _Integral>
_GLIBCXX20_CONSTEXPR inline bool __valid_range_aux(
    _Integral, _Integral, typename _Distance_traits<_Integral>::__type& __dist,
    std::__true_type) {
...
_GLIBCXX_CONSTEXPR inline bool __valid_range_aux(_InputIterator __first,
...
template <typename _InputIterator>
_GLIBCXX_CONSTEXPR inline bool __valid_range_aux(
    _InputIterator __first, _InputIterator __last,
    std::random_access_iterator_tag) {
  return __valid_range_aux(__first, __last, std::input_iterator_tag()) &&
         __first <= __last;
}
...
_GLIBCXX_CONSTEXPR inline bool __valid_range_aux(_InputIterator __first,
                                                 _InputIterator __last,
                                                 std::__false_type) {
  return __valid_range_aux(__first, __last, std::__iterator_category(__first));
}
 ...
 */
template <typename _InputIterator>
_GLIBCXX20_CONSTEXPR inline bool __valid_range(
    _InputIterator __first, _InputIterator __last,
    typename _Distance_traits<_InputIterator>::__type& __dist) {
...
template <typename _Iterator, typename _Sequence, typename _Category>
bool __valid_range(const _Safe_iterator<_Iterator, _Sequence, _Category>&,
                   const _Safe_iterator<_Iterator, _Sequence, _Category>&,
                   typename _Distance_traits<_Iterator>::__type&);

#if __cplusplus >= 201103L
template <typename _Iterator, typename _Sequence>
bool __valid_range(const _Safe_local_iterator<_Iterator, _Sequence>&,
                   const _Safe_local_iterator<_Iterator, _Sequence>&,
                   typename _Distance_traits<_Iterator>::__type&);
#endif

template <typename _InputIterator>
_GLIBCXX14_CONSTEXPR inline bool __valid_range(_InputIterator __first,
                                               _InputIterator __last) {
...
_GLIBCXX_CONSTEXPR inline bool __can_advance(_InputIterator, _Size) {
  return true;
}

template <typename _Iterator, typename _Sequence, typename _Category,
          typename _Size>
bool __can_advance(const _Safe_iterator<_Iterator, _Sequence, _Category>&,
                   _Size);
 ...
 */
template <typename _Iterator>
_GLIBCXX_CONSTEXPR inline _Iterator __base(_Iterator __it) {
  return __it;
}
...
template <typename _Iterator>
inline _Iterator __unsafe(_Iterator __it) {
  return __it;
}
}  // namespace __gnu_debug
