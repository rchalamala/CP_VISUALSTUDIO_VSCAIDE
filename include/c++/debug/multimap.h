...
namespace std _GLIBCXX_VISIBILITY(default) {
  ...
  class multimap
    ...
    typedef __gnu_debug::_Safe_container<multimap, _Allocator,
                                         __gnu_debug::_Safe_node_sequence>
        _Safe;
   ...
   public:
    ...
    multimap(const multimap& __x) : _Base(__x) {}
    ...
    multimap(initializer_list<value_type> __l, const _Compare& __c = _Compare(),
             const allocator_type& __a = allocator_type())
        : _Base(__l, __c, __a) {}

    explicit multimap(const allocator_type& __a) : _Base(__a) {}
    ...
    multimap(const _Base& __x) : _Base(__x) {}
  ...
  template <typename _Key, typename _Tp, typename _Compare, typename _Allocator>
  inline void swap(multimap<_Key, _Tp, _Compare, _Allocator>& __lhs,
