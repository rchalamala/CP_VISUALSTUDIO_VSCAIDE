...
struct _Sequence_traits {
  ...
  static typename _DistTraits::__type _S_size(const _Sequence& __seq) {
...
class _Safe_iterator : private _Iterator, public _Safe_iterator_base {
 ...
 protected:
  typedef std::__are_same<typename _Sequence::_Base::const_iterator, _Iterator>
      _IsConstant;

  typedef typename __gnu_cxx::__conditional_type<
      _IsConstant::__value, typename _Sequence::_Base::iterator,
      typename _Sequence::_Base::const_iterator>::__type _OtherIterator;

  struct _Attach_single {};

  _Safe_iterator(_Iterator __i, _Safe_sequence_base* __seq,
                 _Attach_single) _GLIBCXX_NOEXCEPT : _Iter_base(__i) {
 ...
 public:
   ...
   */
  _Safe_iterator(_Iterator __i,
                 const _Safe_sequence_base* __seq) _GLIBCXX_NOEXCEPT
      : _Iter_base(__i),
        _Safe_base(__seq, _S_constant()) {
    _GLIBCXX_DEBUG_VERIFY(
        !this->_M_singular(),
        _M_message(__msg_init_singular)._M_iterator(*this, "this"));
  }
  ...
  _Safe_iterator(const _Safe_iterator& __x) _GLIBCXX_NOEXCEPT
    ...
    _GLIBCXX_DEBUG_VERIFY(!__x._M_singular() || __x.base() == _Iterator(),
   ...
   */
  _Safe_iterator(_Safe_iterator&& __x) noexcept : _Iter_base() {
    _GLIBCXX_DEBUG_VERIFY(!__x._M_singular() || __x.base() == _Iterator(),
                          _M_message(__msg_init_copy_singular)
                              ._M_iterator(*this, "this")
                              ._M_iterator(__x, "other"));
  ...
  _Safe_iterator(
      const _Safe_iterator<
          _MutableIterator, _Sequence,
          typename __gnu_cxx::__enable_if<
              _IsConstant::__value &&
                  std::__are_same<_MutableIterator, _OtherIterator>::__value,
              _Category>::__type>& __x) _GLIBCXX_NOEXCEPT
      : _Iter_base(__x.base()) {
    // _GLIBCXX_RESOLVE_LIB_DEFECTS
    // DR 408. Is vector<reverse_iterator<char*> > forbidden?
    _GLIBCXX_DEBUG_VERIFY(
        !__x._M_singular() || __x.base() == _MutableIterator(),
   ...
   */
  _Safe_iterator& operator=(const _Safe_iterator& __x) _GLIBCXX_NOEXCEPT {
    // _GLIBCXX_RESOLVE_LIB_DEFECTS
    // DR 408. Is vector<reverse_iterator<char*> > forbidden?
    _GLIBCXX_DEBUG_VERIFY(!__x._M_singular() || __x.base() == _Iterator(),
  ...
  _Safe_iterator& operator=(_Safe_iterator&& __x) noexcept {
    _GLIBCXX_DEBUG_VERIFY(
        this != &__x,
        _M_message(__msg_self_move_assign)._M_iterator(*this, "this"));
    _GLIBCXX_DEBUG_VERIFY(!__x._M_singular() || __x.base() == _Iterator(),
                          _M_message(__msg_copy_singular)
                              ._M_iterator(*this, "this")
                              ._M_iterator(__x, "other"));
  ...
  reference operator*() const _GLIBCXX_NOEXCEPT {
    _GLIBCXX_DEBUG_VERIFY(
        ...
        _M_message(__msg_bad_deref)._M_iterator(*this, "this"));
    return *base();
  }
   ...
   */
  _Safe_iterator& operator++() _GLIBCXX_NOEXCEPT {
    _GLIBCXX_DEBUG_VERIFY(this->_M_incrementable(),
                          _M_message(__msg_bad_inc)._M_iterator(*this, "this"));
    __gnu_cxx::__scoped_lock __l(this->_M_get_mutex());
    ++base();
    return *this;
  }
  ...
  static _GLIBCXX_CONSTEXPR bool _S_constant() { return _IsConstant::__value; }

  /**
   * @brief Return the underlying iterator
   */
  _Iterator& base() _GLIBCXX_NOEXCEPT { return *this; }

  const _Iterator& base() const _GLIBCXX_NOEXCEPT { return *this; }
  ...
  bool _M_incrementable() const { return !this->_M_singular() && !_M_is_end(); }
  ...
  typename __gnu_cxx::__conditional_type<_IsConstant::__value, const _Sequence*,
                                         _Sequence*>::__type
  ...
  typename _Distance_traits<_Iterator>::__type _M_get_distance_to(
      const _Safe_iterator& __rhs) const;

  // Get distance from sequence begin up to *this.
  typename _Distance_traits<_Iterator>::__type _M_get_distance_from_begin()
      const;

  // Get distance from *this to sequence end.
  typename _Distance_traits<_Iterator>::__type _M_get_distance_to_end() const;
  ...
  friend bool operator==(const _Self& __lhs,
...
class _Safe_iterator<_Iterator, _Sequence, std::bidirectional_iterator_tag>
  ...
  typedef _Safe_iterator<_Iterator, _Sequence, std::forward_iterator_tag>
      _Safe_base;
 ...
 protected:
  ...
  _Safe_iterator(_Iterator __i, _Safe_sequence_base* __seq,
                 _Attach_single) _GLIBCXX_NOEXCEPT
 ...
 public:
      ...
      const _Safe_iterator<
          ...
          typename __gnu_cxx::__enable_if<
              _Safe_base::_IsConstant::__value &&
                  std::__are_same<_MutableIterator, _OtherIterator>::__value,
              std::bidirectional_iterator_tag>::__type>& __x) _GLIBCXX_NOEXCEPT
      : _Safe_base(__x) {}
  ...
  /** @brief Move assignment. */
  _Safe_iterator& operator=(_Safe_iterator&&) = default;
#else
  /** @brief Copy assignment. */
  ...
  _Safe_iterator operator++(int) _GLIBCXX_NOEXCEPT {
    _GLIBCXX_DEBUG_VERIFY(this->_M_incrementable(),
                          _M_message(__msg_bad_inc)._M_iterator(*this, "this"));
    __gnu_cxx::__scoped_lock __l(this->_M_get_mutex());
    return _Safe_iterator(this->base()++, this->_M_sequence, _Attach_single());
  }
  ...
  _Safe_iterator& operator--() _GLIBCXX_NOEXCEPT {
    _GLIBCXX_DEBUG_VERIFY(this->_M_decrementable(),
                          _M_message(__msg_bad_dec)._M_iterator(*this, "this"));
    __gnu_cxx::__scoped_lock __l(this->_M_get_mutex());
    --this->base();
    return *this;
  }
...
class _Safe_iterator<_Iterator, _Sequence, std::random_access_iterator_tag>
  ...
  typedef _Safe_iterator<_Iterator, _Sequence, std::bidirectional_iterator_tag>
      _Safe_base;
  typedef typename _Safe_base::_OtherIterator _OtherIterator;
 ...
 public:
  ...
  _Safe_iterator(
      const _Safe_iterator<
          ...
          typename __gnu_cxx::__enable_if<
              _Safe_base::_IsConstant::__value &&
                  std::__are_same<_MutableIterator, _OtherIterator>::__value,
              std::random_access_iterator_tag>::__type>& __x) _GLIBCXX_NOEXCEPT
      : _Safe_base(__x) {}
  ...
  reference operator[](difference_type __n) const _GLIBCXX_NOEXCEPT {
    _GLIBCXX_DEBUG_VERIFY(
        this->_M_can_advance(__n) && this->_M_can_advance(__n + 1),
  ...
  _Safe_iterator& operator+=(difference_type __n) _GLIBCXX_NOEXCEPT {
    _GLIBCXX_DEBUG_VERIFY(
        this->_M_can_advance(__n),
        _M_message(__msg_advance_oob)._M_iterator(*this)._M_integer(__n));
    __gnu_cxx::__scoped_lock __l(this->_M_get_mutex());
    this->base() += __n;
    return *this;
  }
  ...
  _Safe_iterator& operator-=(difference_type __n) _GLIBCXX_NOEXCEPT {
    _GLIBCXX_DEBUG_VERIFY(
        this->_M_can_advance(-__n),
        _M_message(__msg_retreat_oob)._M_iterator(*this)._M_integer(__n));
    __gnu_cxx::__scoped_lock __l(this->_M_get_mutex());
    this->base() -= __n;
    return *this;
  }
...
#if __cpp_lib_three_way_comparison
  friend auto operator<=>(const _Self& __lhs, const _Self& __rhs) noexcept {
    _GLIBCXX_DEBUG_VERIFY_REL_OPERANDS(__lhs, __rhs);
    return __lhs.base() <=> __rhs.base();
  }

  friend auto operator<=>(const _Self& __lhs,
  ...
  // parameters.
  friend difference_type operator-(const _Self& __lhs,
                                   const _OtherSelf& __rhs) _GLIBCXX_NOEXCEPT {
  ...
  friend _Self operator+(const _Self& __x,
                         difference_type __n) _GLIBCXX_NOEXCEPT {
    _GLIBCXX_DEBUG_VERIFY(
        __x._M_can_advance(__n),
        _M_message(__msg_advance_oob)._M_iterator(__x)._M_integer(__n));
    return _Safe_iterator(__x.base() + __n, __x._M_sequence);
  }

  friend _Self operator+(difference_type __n,
  ...
  friend _Self operator-(const _Self& __x,
    ...
    _GLIBCXX_DEBUG_VERIFY(
        __x._M_can_advance(-__n),
        _M_message(__msg_retreat_oob)._M_iterator(__x)._M_integer(__n));
    return _Safe_iterator(__x.base() - __n, __x._M_sequence);
  }
};
...
template <typename _Iterator, typename _Sequence, typename _Category,
          typename _Size>
inline bool __can_advance(
    const _Safe_iterator<_Iterator, _Sequence, _Category>& __it, _Size __n) {
  return __it._M_can_advance(__n);
}

template <typename _Iterator, typename _Sequence>
_Iterator __base(const _Safe_iterator<_Iterator, _Sequence,
...
template <typename _Iterator, typename _Sequence>
inline _Iterator __unsafe(const _Safe_iterator<_Iterator, _Sequence>& __it) {
  return __it.base();
}
