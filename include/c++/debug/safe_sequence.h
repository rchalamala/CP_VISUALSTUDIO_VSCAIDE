...
class _Not_equal_to {
 ...
 public:
  ...
  bool operator()(const _Type& __x) const { return __value != __x; }
};
...
class _After_nth_from {
  typedef
      typename std::iterator_traits<_Iterator>::difference_type difference_type;
 ...
 public:
  ...
  bool operator()(const _Iterator& __x) const { return __x - _M_base >= _M_n; }
};
...
template <typename _Sequence>
class _Safe_node_sequence : public _Safe_sequence<_Sequence> {
 protected:
