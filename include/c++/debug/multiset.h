...
namespace std _GLIBCXX_VISIBILITY(default) {
  ...
  class multiset : public __gnu_debug::_Safe_container<
    ...
    typedef __gnu_debug::_Safe_container<multiset, _Allocator,
                                         __gnu_debug::_Safe_node_sequence>
        _Safe;
   ...
   public:
    ...
    multiset(const multiset& __x) : _Base(__x) {}
    ...
    explicit multiset(const allocator_type& __a) : _Base(__a) {}

    multiset(const multiset& __m, const allocator_type& __a)
        : _Base(__m, __a) {}

    multiset(multiset&& __m, const allocator_type& __a) noexcept(
    ...
    multiset(const _Base& __x) : _Base(__x) {}
  ...
  multiset(_InputIterator, _InputIterator, _Compare = _Compare(),
  ...
  template <typename _Key, typename _Compare = less<_Key>,
            ...
            typename = _RequireNotAllocator<_Compare>,
            typename = _RequireAllocator<_Allocator>>
  multiset(initializer_list<_Key>, _Compare = _Compare(),
  ...
  inline bool operator==(const multiset<_Key, _Compare, _Allocator>& __lhs,
  ...
  inline __detail::__synth3way_t<_Key> operator<=>(
      const multiset<_Key, _Compare, _Alloc>& __lhs,
