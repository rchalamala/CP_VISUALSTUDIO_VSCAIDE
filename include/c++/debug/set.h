...
namespace std _GLIBCXX_VISIBILITY(default) {
  ...
  class set
      : public __gnu_debug::_Safe_container<set<_Key, _Compare, _Allocator>,
                                            _Allocator,
                                            __gnu_debug::_Safe_node_sequence>,
        public _GLIBCXX_STD_C::set<_Key, _Compare, _Allocator> {
    typedef _GLIBCXX_STD_C::set<_Key, _Compare, _Allocator> _Base;
    typedef __gnu_debug::_Safe_container<set, _Allocator,
                                         __gnu_debug::_Safe_node_sequence>
        _Safe;
   ...
   public:
    ...
    explicit set(const allocator_type& __a) : _Base(__a) {}

    set(const set& __x, const allocator_type& __a) : _Base(__x, __a) {}

    set(set&& __x, const allocator_type& __a) noexcept(
        noexcept(_Base(std::move(__x._M_base()), __a)))
...
#if __cplusplus >= 201103L
    void insert(initializer_list<value_type> __l) { _Base::insert(__l); }
#endif
  ...
  set(_InputIterator, _InputIterator, _Compare = _Compare(),
      _Allocator = _Allocator())
      -> set<typename iterator_traits<_InputIterator>::value_type, _Compare,
             _Allocator>;
  ...
  inline bool operator==(const set<_Key, _Compare, _Allocator>& __lhs,
  ...
  inline __detail::__synth3way_t<_Key> operator<=>(
      const set<_Key, _Compare, _Alloc>& __lhs,
