...
namespace std _GLIBCXX_VISIBILITY(default) {
   ...
   public:
    ...
    result_type operator()() {
      ...
      if (is_integral<_Engine_result_type>::value &&
        ...
        __return_value = (((_M_g() - _M_g.min()) / (_M_g.max() - _M_g.min())) *
  ...
  class variate_generator {
    ...
    __glibcxx_class_requires(_Engine, _CopyConstructibleConcept)
        ...
        public : typedef _Engine engine_type;
    ...
    result_type operator()(_Tp __value) {
     ...
     * object.
     */
    engine_value_type& engine() { return _M_engine; }

    /**
     * Gets a const reference to the underlying uniform random number
     * generator object.
     */
    const engine_value_type& engine() const { return _M_engine; }

    /**
     * Gets a reference to the underlying random distribution.
     */
    distribution_type& distribution() { return _M_dist; }

    /**
     * Gets a const reference to the underlying random distribution.
     */
    const distribution_type& distribution() const { return _M_dist; }

    /**
     * Gets the closed lower bound of the distribution interval.
     */
    result_type min() const { return this->distribution().min(); }

    /**
     * Gets the closed upper bound of the distribution interval.
     */
    result_type max() const { return this->distribution().max(); }
  ...
  class linear_congruential {
     ...
     */
    explicit linear_congruential(unsigned long __x0 = 1) { this->seed(__x0); }
     ...
     */
    result_type max() const { return __m - 1; }
     ...
     */
    friend bool operator==(const linear_congruential& __lhs,
   ...
   private:
    template <class _Gen>
    void seed(_Gen& __g, true_type) {
      return seed(static_cast<unsigned long>(__g));
    }

    template <class _Gen>
    void seed(_Gen& __g, false_type);
  ...
  class mersenne_twister {
    ...
    explicit mersenne_twister(unsigned long __value) { seed(__value); }
     ...
     * @returns true if the two objects are equal, false otherwise.
     */
    friend bool operator==(const mersenne_twister& __lhs,
    ...
    template <class _UIntType1, int __w1, int __n1, int __m1, int __r1,
              ...
              _UIntType1 __c1, int __l1, typename _CharT, typename _Traits>
    friend std::basic_ostream<_CharT, _Traits>& operator<<(
        std::basic_ostream<_CharT, _Traits>& __os,
        const mersenne_twister<_UIntType1, __w1, __n1, __m1, __r1, __a1, __u1,
                               __s1, __b1, __t1, __c1, __l1>& __x);
    ...
    friend std::basic_istream<_CharT, _Traits>& operator>>(
        std::basic_istream<_CharT, _Traits>& __is,
        mersenne_twister<_UIntType1, __w1, __n1, __m1, __r1, __a1, __u1, __s1,
                         __b1, __t1, __c1, __l1>& __x);
   ...
   */
  typedef mersenne_twister<unsigned long, 32, 624, 397, 31, 0x9908b0dful, 11, 7,
  ...
  class subtract_with_carry {
     ...
     * generator.
     */
    subtract_with_carry() { this->seed(); }

    /**
     * Constructs an explicitly seeded % subtract_with_carry random number
     * generator.
     */
    explicit subtract_with_carry(unsigned long __value) { this->seed(__value); }
     ...
     * returned by this generator.
     */
    result_type max() const { return this->modulus - 1; }
     ...
     * @returns true if the two objects are equal, false otherwise.
     */
    friend bool operator==(const subtract_with_carry& __lhs,
  ...
  class subtract_with_carry_01 {
   public:
     ...
     * generator.
     */
    explicit subtract_with_carry_01(unsigned long __value) {
      this->seed(__value);
      _M_initialize_npows();
    }
     ...
     * @returns true if the two objects are equal, false otherwise.
     */
    friend bool operator==(const subtract_with_carry_01& __lhs,
  ...
  class discard_block {
   ...
   public:
     ...
     */
    explicit discard_block(const base_type& __rng) : _M_b(__rng), _M_n(0) {}
     ...
     */
    explicit discard_block(unsigned long __s) : _M_b(__s), _M_n(0) {}
     ...
     */
    template <class _Gen>
    discard_block(_Gen& __g) : _M_b(__g), _M_n(0) {}
     ...
     */
    const base_type& base() const { return _M_b; }

    /**
     * Gets the minimum value in the generated random number range.
     */
    result_type min() const { return _M_b.min(); }

    /**
     * Gets the maximum value in the generated random number range.
     */
    result_type max() const { return _M_b.max(); }
     ...
     * @returns true if the two objects are equal, false otherwise.
     */
    friend bool operator==(const discard_block& __lhs,
   ...
   */
  typedef discard_block<subtract_with_carry<unsigned long, (1UL << 24), 10, 24>,
                        223, 24>
      ranlux3;
  ...
  class xor_combine {
   ...
   public:
    ...
    typedef typename __gnu_cxx::__conditional_type<
        (sizeof(_Result_type1) > sizeof(_Result_type2)), _Result_type1,
        _Result_type2>::__type result_type;
    ...
    // constructors and member function
    xor_combine() : _M_b1(), _M_b2() { _M_initialize_max(); }
    ...
    xor_combine(unsigned long __s) : _M_b1(__s), _M_b2(__s + 1) {
      _M_initialize_max();
    }

    template <class _Gen>
    xor_combine(_Gen& __g) : _M_b1(__g), _M_b2(__g) {
      _M_initialize_max();
    }
    ...
    const base1_type& base1() const { return _M_b1; }

    const base2_type& base2() const { return _M_b2; }

    result_type min() const { return 0; }

    result_type max() const { return _M_max; }
     ...
     * @returns true if the two objects are equal, false otherwise.
     */
    friend bool operator==(const xor_combine& __lhs, const xor_combine& __rhs) {
    ...
    template <class _UniformRandomNumberGenerator11, int __s11,
              class _UniformRandomNumberGenerator21, int __s21, typename _CharT,
              typename _Traits>
    friend std::basic_ostream<_CharT, _Traits>& operator<<(
        std::basic_ostream<_CharT, _Traits>& __os,
   ...
   private:
    void _M_initialize_max();

    result_type _M_initialize_max_aux(result_type, result_type, int);
  ...
  class random_device {
   public:
    ...
    explicit random_device(const std::string& __token = "mt19937")
...
#ifdef _GLIBCXX_USE_RANDOM_TR1
      result_type __ret;
      std::fread(reinterpret_cast<void*>(&__ret), sizeof(result_type), 1,
                 _M_file);
      return __ret;
#else
      return _M_mt();
  ...
  class uniform_int {
   ...
   public:
     ...
     */
    explicit uniform_int(_IntType __min = 0, _IntType __max = 9)
     ...
     */
    result_type min() const { return _M_min; }
    ...
    result_type operator()(_UniformRandomNumberGenerator& __urng) {
      typedef typename _UniformRandomNumberGenerator::result_type _UResult_type;
    ...
    template <typename _IntType1, typename _CharT, typename _Traits>
    friend std::basic_istream<_CharT, _Traits>& operator>>(
        std::basic_istream<_CharT, _Traits>& __is, uniform_int<_IntType1>& __x);

   private:
    template <typename _UniformRandomNumberGenerator>
    result_type _M_call(_UniformRandomNumberGenerator& __urng,
    ...
    result_type _M_call(_UniformRandomNumberGenerator& __urng,
      ...
      return result_type((__urng() - __urng.min()) /
                         (__urng.max() - __urng.min()) * (__max - __min + 1)) +
             __min;
    }
  ...
  class bernoulli_distribution {
   ...
   public:
     ...
     */
    explicit bernoulli_distribution(double __p = 0.5) : _M_p(__p) {
  ...
  class geometric_distribution {
   public:
    ...
    // constructors and member function
    explicit geometric_distribution(const _RealType& __p = _RealType(0.5))
        : _M_p(__p) {
      _GLIBCXX_DEBUG_ASSERT((_M_p > 0.0) && (_M_p < 1.0));
      _M_initialize();
    }
     ...
     * an error state.
     */
    template <typename _IntType1, typename _RealType1, typename _CharT,
              typename _Traits>
    friend std::basic_ostream<_CharT, _Traits>& operator<<(
        std::basic_ostream<_CharT, _Traits>& __os,
   ...
   private:
    void _M_initialize() { _M_log_p = std::log(_M_p); }
  ...
  class poisson_distribution {
   public:
    ...
    // constructors and member function
    explicit poisson_distribution(const _RealType& __mean = _RealType(1))
  ...
  class binomial_distribution {
   public:
    ...
    // constructors and member function
    explicit binomial_distribution(_IntType __t = 1,
  ...
  class normal_distribution {
   ...
   public:
     ...
     * @f$ \sigma @f$.
     */
    explicit normal_distribution(const result_type& __mean = result_type(0),
     ...
     */
    _RealType sigma() const { return _M_sigma; }
  ...
  class gamma_distribution {
   ...
   public:
     ...
     */
    explicit gamma_distribution(const result_type& __alpha_val = result_type(1))
    ...
    template <typename _CharT, typename _Traits>
    friend std::basic_istream<_CharT, _Traits>& operator>>(
        std::basic_istream<_CharT, _Traits>& __is, gamma_distribution& __x) {
      __is >> __x._M_alpha;
      __x._M_initialize();
      return __is;
    }
