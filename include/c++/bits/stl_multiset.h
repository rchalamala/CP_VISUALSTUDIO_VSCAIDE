...
namespace std _GLIBCXX_VISIBILITY(default) {
  ...
  class multiset {
    ...
    __glibcxx_class_requires(_Key, _SGIAssignableConcept)
        ...
        __glibcxx_class_requires4(
            ...
            _BinaryFunctionConcept) __glibcxx_class_requires2(_Key,
                                                              _Alloc_value_type,
                                                              _SameTypeConcept)
#endif
    ...
    static_assert(
        is_same<typename _Alloc::value_type, _Key>::value,
   ...
   public:
     ...
     *  according to the keys.
     */
    iterator cbegin() const noexcept { return _M_t.begin(); }
     ...
     *  according to the keys.
     */
    iterator cend() const noexcept { return _M_t.end(); }
     ...
     *  according to the keys.
     */
    reverse_iterator crbegin() const noexcept { return _M_t.rbegin(); }
     ...
     *  according to the keys.
     */
    reverse_iterator crend() const noexcept { return _M_t.rend(); }
#endif
    ...
    template <typename _K1, typename _C1, typename _A1>
    friend __detail::__synth3way_t<_K1> operator<=>(
  ...
  struct _Rb_tree_merge_helper<_GLIBCXX_STD_C::multiset<_Val, _Cmp1, _Alloc>,
                               _Cmp2> {
   private:
    friend class _GLIBCXX_STD_C::multiset<_Val, _Cmp1, _Alloc>;

    static auto& _S_get_tree(_GLIBCXX_STD_C::set<_Val, _Cmp2, _Alloc>& __set) {
      return __set._M_t;
    }

    static auto& _S_get_tree(
        _GLIBCXX_STD_C::multiset<_Val, _Cmp2, _Alloc>& __set) {
      return __set._M_t;
    }
  };
#endif  // C++17
