...
#undef _GLIBCXX_MEM_FN_TRAITS2
...
#endif
  {
   ...
   public:
    ...
    _GLIBCXX20_CONSTEXPR reference_wrapper(_Up&& __uref) noexcept(
    ...
    _GLIBCXX20_CONSTEXPR typename result_of<_Tp&(_Args&&...)>::type operator()(
        _Args&&... __args) const {
#if __cplusplus > 201703L
  ...
  template <typename _Tp>
  _GLIBCXX20_CONSTEXPR inline reference_wrapper<const _Tp> cref(
  ...
  template <typename _Tp>
  _GLIBCXX20_CONSTEXPR inline reference_wrapper<_Tp> ref(
