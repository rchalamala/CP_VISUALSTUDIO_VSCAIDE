...
#define __cpp_lib_unordered_map_try_emplace 201411
    ...
    pair<iterator, bool> try_emplace(const key_type& __k, _Args&&... __args) {
      ...
      if (__i == end()) {
        __i = emplace(std::piecewise_construct, std::forward_as_tuple(__k),
    ...
    iterator try_emplace(const_iterator __hint, const key_type& __k,
      ...
      if (__i == end())
        __i = emplace_hint(
            __hint, std::piecewise_construct, std::forward_as_tuple(__k),
            std::forward_as_tuple(std::forward<_Args>(__args)...));
      return __i;
    }
    ...
    iterator try_emplace(const_iterator __hint, key_type&& __k,
      ...
      if (__i == end())
        __i =
            emplace_hint(__hint, std::piecewise_construct,
                         std::forward_as_tuple(std::move(__k)),
                         std::forward_as_tuple(std::forward<_Args>(__args)...));
      return __i;
    }
  ...
  struct _Hash_merge_helper<
      _GLIBCXX_STD_C::unordered_map<_Key, _Val, _Hash1, _Eq1, _Alloc>, _Hash2,
      _Eq2> {
   private:
    ...
    static auto& _S_get_table(
        unordered_map<_Key, _Val, _Hash2, _Eq2, _Alloc>& __map) {
      return __map._M_h;
    }

    static auto& _S_get_table(
        unordered_multimap<_Key, _Val, _Hash2, _Eq2, _Alloc>& __map) {
      return __map._M_h;
    }
  };
