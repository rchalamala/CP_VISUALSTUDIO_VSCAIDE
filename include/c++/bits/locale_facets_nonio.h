...
namespace std _GLIBCXX_VISIBILITY(default) {
  ...
  struct __timepunct_cache : public locale::facet {
    ...
    __timepunct_cache(size_t __refs = 0)
        : facet(__refs),
          _M_date_format(0),
          _M_date_era_format(0),
          _M_time_format(0),
          _M_time_era_format(0),
          _M_date_time_format(0),
          _M_date_time_era_format(0),
          _M_am(0),
          _M_pm(0),
          _M_am_pm_format(0),
          _M_day1(0),
   ...
   private:
    __timepunct_cache& operator=(const __timepunct_cache&);
  ...
  // Specializations.
  template <>
  const char* __timepunct_cache<char>::_S_timezones[14];

#ifdef _GLIBCXX_USE_WCHAR_T
  template <>
  const wchar_t* __timepunct_cache<wchar_t>::_S_timezones[14];
#endif
  ...
  class __timepunct : public locale::facet {
   ...
   public:
    ...
    void _M_put(_CharT* __s, size_t __maxlen, const _CharT* __format,
    ...
    void _M_am_pm_format(
        const _CharT*) const { /* Kept for ABI compatibility, see PR65927 */
    }
#endif
  ...
  // Specializations.
  template <>
  void __timepunct<char>::_M_initialize_timepunct(__c_locale __cloc);

  template <>
  void __timepunct<char>::_M_put(char*, size_t, const char*, const tm*)
      const throw();

#ifdef _GLIBCXX_USE_WCHAR_T
  template <>
  void __timepunct<wchar_t>::_M_initialize_timepunct(__c_locale __cloc);

  template <>
  void __timepunct<wchar_t>::_M_put(wchar_t*, size_t, const wchar_t*, const tm*)
      const throw();
#endif
...
namespace std _GLIBCXX_VISIBILITY(default) {
  ...
  class time_get : public locale::facet, public time_base {
   public:
     ...
     */
    explicit time_get(size_t __refs = 0) : facet(__refs) {}
     ...
     */
    iter_type get_weekday(iter_type __beg, iter_type __end, ios_base& __io,
                          ios_base::iostate& __err, tm* __tm) const {
     ...
     */
    iter_type get_monthname(iter_type __beg, iter_type __end, ios_base& __io,
                            ios_base::iostate& __err, tm* __tm) const {
     ...
     */
    inline iter_type get(iter_type __s, iter_type __end, ios_base& __io,
   ...
   protected:
    ...
    iter_type _M_extract_num(iter_type __beg, iter_type __end, int& __member,
                             int __min, int __max, size_t __len, ios_base& __io,
                             ios_base::iostate& __err) const;

    // Extract any unique array of string literals in a const _CharT* array.
    iter_type _M_extract_name(iter_type __beg, iter_type __end, int& __member,
    ...
    iter_type _M_extract_wday_or_month(iter_type __beg, iter_type __end,
                                       int& __member, const _CharT** __names,
                                       size_t __indexlen, ios_base& __io,
                                       ios_base::iostate& __err) const;

    // Extract on a component-by-component basis, via __format argument.
    iter_type _M_extract_via_format(iter_type __beg, iter_type __end,
                                    ios_base& __io, ios_base::iostate& __err,
                                    tm* __tm, const _CharT* __format) const;
  };
...
#if __cplusplus >= 201103L
    explicit time_get_byname(const string& __s, size_t __refs = 0)
  ...
  class time_put : public locale::facet {
   public:
     ...
     *  @param __refs  Passed to the base facet class.
     */
    explicit time_put(size_t __refs = 0) : facet(__refs) {}
    ...
    iter_type put(iter_type __s, ios_base& __io, char_type __fill,
                  const tm* __tm, const _CharT* __beg,
   ...
   protected:
    ...
    virtual iter_type do_put(iter_type __s, ios_base& __io, char_type __fill,
                             const tm* __tm, char __format, char __mod) const;
  };
...
#if __cplusplus >= 201103L
    explicit time_put_byname(const string& __s, size_t __refs = 0)
  ...
  class money_base {
   public:
    ...
    _GLIBCXX_CONST static pattern _S_construct_pattern(char __precedes,
                                                       char __space,
                                                       char __posn) throw();
  };
  ...
  struct __moneypunct_cache : public locale::facet {
    ...
    __moneypunct_cache(size_t __refs = 0)
        : facet(__refs),
          ...
          _M_neg_format(money_base::pattern()),
          _M_allocated(false) {}
  ...
  class moneypunct : public locale::facet, public money_base {
   ...
   public:
     ...
     *  @param __refs  Passed to the base facet class.
     */
    explicit moneypunct(size_t __refs = 0) : facet(__refs), _M_data(0) {
     ...
     *  @param __refs  Passed to the base facet class.
     */
    explicit moneypunct(__cache_type* __cache, size_t __refs = 0)
     ...
     *  @param __refs  Passed to the base facet class.
     */
    explicit moneypunct(__c_locale __cloc, const char* __s, size_t __refs = 0)
     ...
     */
    string_type curr_symbol() const { return this->do_curr_symbol(); }
     ...
     */
    string_type positive_sign() const { return this->do_positive_sign(); }
     ...
     */
    string_type negative_sign() const { return this->do_negative_sign(); }
     ...
     */
    pattern pos_format() const { return this->do_pos_format(); }

    pattern neg_format() const { return this->do_neg_format(); }
    //@}
   ...
   protected:
     ...
     *  @return  Number of digits in amount fraction.
     */
    virtual int do_frac_digits() const { return _M_data->_M_frac_digits; }
     ...
     *  @return  Pattern for money values.
     */
    virtual pattern do_neg_format() const { return _M_data->_M_neg_format; }

    // For use at construction time only.
    void _M_initialize_moneypunct(__c_locale __cloc = 0,
                                  const char* __name = 0);
  };
  ...
  template <>
  void moneypunct<char, true>::_M_initialize_moneypunct(__c_locale,
                                                        const char*);

  template <>
  void moneypunct<char, false>::_M_initialize_moneypunct(__c_locale,
                                                         const char*);
  ...
  template <>
  void moneypunct<wchar_t, true>::_M_initialize_moneypunct(__c_locale,
                                                           const char*);

  template <>
  void moneypunct<wchar_t, false>::_M_initialize_moneypunct(__c_locale,
                                                            const char*);
#endif
  ...
  class moneypunct_byname : public moneypunct<_CharT, _Intl> {
   public:
    ...
    explicit moneypunct_byname(const char* __s, size_t __refs = 0)
...
#if __cplusplus >= 201103L
    explicit moneypunct_byname(const string& __s, size_t __refs = 0)
  ...
  class money_get : public locale::facet {
   public:
     ...
     *	   amount.
     */
    iter_type get(iter_type __s, iter_type __end, bool __intl, ios_base& __io,
   ...
   protected:
    ...
    virtual iter_type __do_get(iter_type __s, iter_type __end, bool __intl,
                               ios_base& __io, ios_base::iostate& __err,
    ...
    template <bool _Intl>
    iter_type _M_extract(iter_type __s, iter_type __end, ios_base& __io,
  ...
  class money_put : public locale::facet {
   public:
     ...
     *  @param __refs  Passed to the base facet class.
     */
    explicit money_put(size_t __refs = 0) : facet(__refs) {}
     ...
     *  @return  Iterator after writing.
     */
    iter_type put(iter_type __s, bool __intl, ios_base& __io, char_type __fill,
                  long double __units) const {
   ...
   protected:
...
#if defined _GLIBCXX_LONG_DOUBLE_COMPAT && defined __LONG_DOUBLE_128__ && \
    _GLIBCXX_USE_CXX11_ABI == 0
    virtual iter_type __do_put(iter_type __s, bool __intl, ios_base& __io,
    ...
    template <bool _Intl>
    iter_type _M_insert(iter_type __s, ios_base& __io, char_type __fill,
                        const string_type& __digits) const;
  };
  ...
  class messages : public locale::facet, public messages_base {
   ...
   public:
     ...
     */
    void close(catalog __c) const { return this->do_close(__c); }
  ...
  template <>
  string messages<char>::do_get(catalog, int, int, const string&) const;

#ifdef _GLIBCXX_USE_WCHAR_T
  template <>
  wstring messages<wchar_t>::do_get(catalog, int, int, const wstring&) const;
#endif
  ...
  class messages_byname : public messages<_CharT> {
   public:
    ...
    explicit messages_byname(const char* __s, size_t __refs = 0);

#if __cplusplus >= 201103L
    explicit messages_byname(const string& __s, size_t __refs = 0)
