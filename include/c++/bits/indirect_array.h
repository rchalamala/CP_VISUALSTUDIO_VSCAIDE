...
namespace std _GLIBCXX_VISIBILITY(default) {
  ...
  template <typename _Tp>
  inline indirect_array<_Tp>::indirect_array(_Array<_Tp> __a, size_t __s,
                                             _Array<size_t> __i)
      : _M_sz(__s), _M_index(__i), _M_array(__a) {}

  template <typename _Tp>
  inline indirect_array<_Tp>& indirect_array<_Tp>::operator=(
  ...
  template <typename _Tp>
  template <class _Dom>
  inline void indirect_array<_Tp>::operator=(const _Expr<_Dom, _Tp>& __e)
      const {
...
#define _DEFINE_VALARRAY_OPERATOR(_Op, _Name)                                \
  template <typename _Tp>                                                    \
  inline void indirect_array<_Tp>::operator _Op##=(const valarray<_Tp>& __v) \
      const {                                                                \
  ...
  template <typename _Tp>                                                    \
  template <class _Dom>                                                      \
  inline void indirect_array<_Tp>::operator _Op##=(                          \
      const _Expr<_Dom, _Tp>& __e) const {                                   \
