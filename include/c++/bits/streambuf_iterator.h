...
namespace std _GLIBCXX_VISIBILITY(default) {
  ...
  class istreambuf_iterator
   ...
   public:
    ...
    friend __enable_if_t<__is_char<_CharT2>::__value, _CharT2*> __copy_n_a(
   ...
   public:
...
#if __cplusplus >= 201103L
    istreambuf_iterator& operator=(const istreambuf_iterator&) noexcept =
        default;
#endif
    ...
    char_type operator*() const {
      ...
      __glibcxx_requires_cond(
          !_S_is_eof(__c),
          _M_message(__gnu_debug::__msg_deref_istreambuf)._M_iterator(*this));
#endif
    ...
    istreambuf_iterator& operator++() {
      __glibcxx_requires_cond(
          _M_sbuf && (!_S_is_eof(_M_c) || !_S_is_eof(_M_sbuf->sgetc())),
...
#if __cplusplus > 201703L && __cpp_lib_concepts
    friend bool operator==(const istreambuf_iterator& __i,
                           default_sentinel_t __s) {
  ...
  class ostreambuf_iterator
   ...
   public:
    ...
    bool failed() const _GLIBCXX_USE_NOEXCEPT { return _M_failed; }
  ...
  copy(istreambuf_iterator<_CharT> __first, istreambuf_iterator<_CharT> __last,
    ...
    if (__first._M_sbuf && !__last._M_sbuf && !__result._M_failed) {
      ...
      if (!__ineof) __result._M_failed = true;
    }
    return __result;
  }
  ...
  __copy_move_a2(_CharT * __first, _CharT * __last,
    ...
    if (__num > 0) __result._M_put(__first, __num);
    return __result;
  }
  ...
  __enable_if_t<__is_char<_CharT>::__value, _CharT*> __copy_n_a(
      istreambuf_iterator<_CharT> __it, _Size __n, _CharT * __result) {
    if (__n == 0) return __result;

    __glibcxx_requires_cond(
        __it._M_sbuf,
        _M_message(__gnu_debug::__msg_inc_istreambuf)._M_iterator(__it));
  ...
  advance(istreambuf_iterator<_CharT> & __i, _Distance __n) {
    ...
    __glibcxx_requires_cond(
        !__i._M_at_eof(),
        _M_message(__gnu_debug::__msg_inc_istreambuf)._M_iterator(__i));
