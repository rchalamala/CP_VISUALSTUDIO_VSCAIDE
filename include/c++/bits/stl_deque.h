...
#define _GLIBCXX_DEQUE_BUF_SIZE 512
  ...
  struct _Deque_iterator {
   ...
   public:
    ...
    _Deque_iterator() _GLIBCXX_NOEXCEPT : _M_cur(),
                                          _M_first(),
                                          _M_last(),
                                          _M_node() {}
    ...
    friend bool operator==(const _Self& __x,
    ...
    friend strong_ordering operator<=>(const _Self& __x,
    ...
    friend difference_type operator-(const _Self& __x,
                                     const _Self& __y) _GLIBCXX_NOEXCEPT {
  ...
  class _Deque_base {
   protected:
    ...
    typedef
        typename _Alloc_traits::template rebind<_Ptr>::other _Map_alloc_type;
    ...
    _Deque_base(const allocator_type& __a)
        : _M_impl(__a) { /* Caller must initialize map. */
    }
    ...
    struct _Deque_impl_data {
      ...
      _Deque_impl_data() _GLIBCXX_NOEXCEPT : _M_map(),
                                             _M_map_size(),
                                             _M_start(),
                                             _M_finish() {}
      ...
      _Deque_impl_data& operator=(const _Deque_impl_data&) = default;
      ...
      void _M_swap_data(_Deque_impl_data& __x) _GLIBCXX_NOEXCEPT {
    ...
    struct _Deque_impl : public _Tp_alloc_type, public _Deque_impl_data {
    ...
    void _M_deallocate_node(_Ptr __p) _GLIBCXX_NOEXCEPT {
      typedef __gnu_cxx::__alloc_traits<_Tp_alloc_type> _Traits;
    ...
    void _M_deallocate_map(_Map_pointer __p, size_t __n) _GLIBCXX_NOEXCEPT {
      _Map_alloc_type __map_alloc = _M_get_map_allocator();
  ...
  template <typename _Tp, typename _Alloc>
  _Deque_base<_Tp, _Alloc>::~_Deque_base() _GLIBCXX_NOEXCEPT {
  ...
  void _Deque_base<_Tp, _Alloc>::_M_initialize_map(size_t __num_elements) {
    ...
    _Map_pointer __nstart =
        (this->_M_impl._M_map + (this->_M_impl._M_map_size - __num_nodes) / 2);
  ...
  void _Deque_base<_Tp, _Alloc>::_M_destroy_nodes(
      _Map_pointer __nstart, _Map_pointer __nfinish) _GLIBCXX_NOEXCEPT {
  ...
  class deque : protected _Deque_base<_Tp, _Alloc> {
   ...
   public:
    ...
    void push_front(const value_type& __x) {
      if (this->_M_impl._M_start._M_cur != this->_M_impl._M_start._M_first) {
        _Alloc_traits::construct(this->_M_impl,
                                 this->_M_impl._M_start._M_cur - 1, __x);
    ...
    void push_back(const value_type& __x) {
      if (this->_M_impl._M_finish._M_cur !=
        ...
        _Alloc_traits::construct(this->_M_impl, this->_M_impl._M_finish._M_cur,
                                 __x);
        ++this->_M_impl._M_finish._M_cur;
      } else
     ...
     */
    void swap(deque& __x) _GLIBCXX_NOEXCEPT {
#if __cplusplus >= 201103L
   ...
   protected:
    ...
    void _M_reserve_map_at_front(size_type __nodes_to_add = 1) {
      if (__nodes_to_add >
          size_type(this->_M_impl._M_start._M_node - this->_M_impl._M_map))
    ...
    void _M_move_assign1(deque&& __x, /* always equal: */ true_type) noexcept {
      this->_M_impl._M_swap_data(__x._M_impl);
      __x.clear();
    ...
    void _M_move_assign1(deque&& __x, /* always equal: */ false_type) {
    ...
    void _M_move_assign2(deque&& __x, /* propagate: */ true_type) {
    ...
    void _M_move_assign2(deque&& __x, /* propagate: */ false_type) {
