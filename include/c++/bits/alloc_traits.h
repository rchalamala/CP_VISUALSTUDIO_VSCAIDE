...
#define __cpp_lib_allocator_traits_is_always_equal 201411
  ...
  struct allocator_traits : __allocator_traits_base {
   ...
   private:
    ...
    static _GLIBCXX14_CONSTEXPR auto _S_destroy(
        _Alloc2& __a, _Tp* __p, int) noexcept(noexcept(__a.destroy(__p)))
        -> decltype(__a.destroy(__p)) {
      __a.destroy(__p);
    }

    template <typename _Alloc2, typename _Tp>
    static _GLIBCXX14_CONSTEXPR void _S_destroy(
        _Alloc2&, _Tp* __p,
   ...
   public:
     ...
     */
    static _GLIBCXX20_CONSTEXPR void deallocate(_Alloc& __a, pointer __p,
                                                size_type __n) {
     ...
     */
    template <typename _Tp>
    static _GLIBCXX20_CONSTEXPR void destroy(_Alloc& __a, _Tp* __p) noexcept(
     ...
     */
    static _GLIBCXX20_CONSTEXPR size_type max_size(const _Alloc& __a) noexcept {
...
#define __cpp_lib_constexpr_dynamic_alloc 201907L
  ...
  struct allocator_traits<allocator<_Tp>> {
     ...
     *  Calls <tt> a.deallocate(p, n) </tt>
     */
    static _GLIBCXX20_CONSTEXPR void deallocate(allocator_type& __a,
    ...
    static _GLIBCXX20_CONSTEXPR void construct(
     ...
     */
    template <typename _Up>
    static _GLIBCXX20_CONSTEXPR void destroy(
        allocator_type& __a __attribute__((__unused__)),
  ...
  template <typename _Alloc>
  _GLIBCXX14_CONSTEXPR inline void __alloc_on_copy(_Alloc & __one,
                                                   const _Alloc& __two) {
    typedef allocator_traits<_Alloc> __traits;
    typedef typename __traits::propagate_on_container_copy_assignment __pocca;
#if __cplusplus >= 201703L
    if constexpr (__pocca::value) __one = __two;
#else
...
#if __cplusplus >= 201703L
    if constexpr (__pocma::value) __one = std::move(__two);
#else
  ...
  template <typename _Alloc>
  _GLIBCXX14_CONSTEXPR inline void __alloc_on_swap(_Alloc & __one,
                                                   _Alloc & __two) {
    typedef allocator_traits<_Alloc> __traits;
