...
namespace std _GLIBCXX_VISIBILITY(default) {
  ...
  inline _GLIBCXX_CONSTEXPR _Ios_Fmtflags operator&(_Ios_Fmtflags __a,
                                                    _Ios_Fmtflags __b) {
  ...
  inline _GLIBCXX_CONSTEXPR _Ios_Openmode operator&(_Ios_Openmode __a,
                                                    _Ios_Openmode __b) {
  ...
  inline _GLIBCXX_CONSTEXPR _Ios_Iostate operator&(_Ios_Iostate __a,
                                                   _Ios_Iostate __b) {
