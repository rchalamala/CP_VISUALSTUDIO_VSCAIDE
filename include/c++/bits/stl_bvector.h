...
namespace std _GLIBCXX_VISIBILITY(default) {
  ...
  struct _Bit_reference {
    ...
    operator bool() const _GLIBCXX_NOEXCEPT { return !!(*_M_p & _M_mask); }
    ...
    void flip() _GLIBCXX_NOEXCEPT { *_M_p ^= _M_mask; }
  };
  ...
  struct _Bit_iterator_base
    ...
    friend constexpr strong_ordering operator<=>(
        const _Bit_iterator_base& __x, const _Bit_iterator_base& __y) noexcept {
      if (const auto __cmp = __x._M_p <=> __y._M_p; __cmp != 0) return __cmp;
      return __x._M_offset <=> __y._M_offset;
    }
#else
    friend bool operator<(const _Bit_iterator_base& __x,
                          const _Bit_iterator_base& __y) {
    ...
    friend ptrdiff_t operator-(const _Bit_iterator_base& __x,
                               const _Bit_iterator_base& __y) {
  ...
  struct _Bit_iterator : public _Bit_iterator_base {
    ...
    friend iterator operator+(const iterator& __x, difference_type __n) {
      iterator __tmp = __x;
      __tmp += __n;
      return __tmp;
    }

    friend iterator operator+(difference_type __n, const iterator& __x) {
      return __x + __n;
    }
  ...
  struct _Bit_const_iterator : public _Bit_iterator_base {
    ...
    friend const_iterator operator+(const const_iterator& __x,
                                    difference_type __n) {
  ...
  inline void __fill_bvector(_Bit_type * __v, unsigned int __first,
                             unsigned int __last, bool __x) {
  ...
  struct _Bvector_base {
    ...
    struct _Bvector_impl_data {
      ...
      _Bvector_impl_data() _GLIBCXX_NOEXCEPT : _M_start(),
                                               _M_finish(),
                                               _M_end_of_storage() {}
