...
#define _GLIBCXX_NUM_UNICODE_FACETS 2
  ...
  inline _OutIter __write(_OutIter __s, const _CharT* __ws, int __len) {
    for (int __j = 0; __j < __len; __j++, ++__s) *__s = __ws[__j];
    return __s;
  }
...
namespace std _GLIBCXX_VISIBILITY(default) {
  ...
  class num_get : public locale::facet {
   ...
   protected:
    ...
    _GLIBCXX_DEFAULT_ABI_TAG iter_type _M_extract_int(iter_type, iter_type,
                                                      ios_base&,
                                                      ios_base::iostate&,
                                                      _ValueT&) const;
    ...
    virtual iter_type __do_get(iter_type, iter_type, ios_base&,
                               ios_base::iostate&, double&) const;
#else
    virtual iter_type do_get(iter_type, iter_type, ios_base&,
