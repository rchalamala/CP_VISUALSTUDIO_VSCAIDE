  ...
  struct pair : private __pair_base<_T1, _T2> {
    ...
    template <typename _U1 = _T1, typename _U2 = _T2,
              typename enable_if<
                  ...
                  bool>::type = true>
#endif
    _GLIBCXX_CONSTEXPR pair() : first(), second() {
    }
    ...
    // DR 811.
    template <typename _U1, typename enable_if<
    ...
    template <typename _U2, typename enable_if<
    ...
    _GLIBCXX20_CONSTEXPR pair(piecewise_construct_t, tuple<_Args1...>,
                              tuple<_Args2...>);

    _GLIBCXX20_CONSTEXPR pair& operator=(
    ...
    _GLIBCXX20_CONSTEXPR void swap(pair& __p) noexcept(
   ...
   private:
    ...
    _GLIBCXX20_CONSTEXPR pair(tuple<_Args1...>&, tuple<_Args2...>&,
