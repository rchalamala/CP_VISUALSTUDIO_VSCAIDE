...
namespace std _GLIBCXX_VISIBILITY(default) {
  ...
  template <typename _UIntType, size_t __w,
            bool = __w<static_cast<size_t>(
                std::numeric_limits<_UIntType>::digits)> struct _Shift {
  ...
  template <typename _Tp, _Tp __m, _Tp __a, _Tp __c,
    ...
    typedef
        typename _Select_uint_least_t<std::__lg(__a) + std::__lg(__m) + 2>::type
            _Tp2;
   ...
   public:
    ...
    _DInputType operator()() {
      return std::generate_canonical<
          _DInputType, std::numeric_limits<_DInputType>::digits, _Engine>(_M_g);
    }
  ...
  using __seed_seq_generate_t = decltype(std::declval<_Sseq&>().generate(
  ...
  using __is_seed_seq =
      __and_<__not_<is_same<__remove_cvref_t<_Sseq>, _Engine>>,
  ...
  class linear_congruential_engine {
   ...
   public:
     ...
     */
    static constexpr result_type min() { return __c == 0u ? 1u : 0u; }

    /**
     * @brief Gets the largest possible value in the output range.
     */
    static constexpr result_type max() { return __m - 1u; }
    ...
    friend std::basic_ostream<_CharT, _Traits>& operator<<(
        ...
        const std::linear_congruential_engine<_UIntType1, __a1, __c1, __m1>&
            __lcr);
  ...
  inline bool operator!=(
      ...
      const std::linear_congruential_engine<_UIntType, __a, __c, __m>& __rhs) {
    return !(__lhs == __rhs);
  }
   ...
   */
  template <typename _UIntType, size_t __w, size_t __n, size_t __m, size_t __r,
            _UIntType __a, size_t __u, _UIntType __d, size_t __s, _UIntType __b,
            size_t __t, _UIntType __c, size_t __l, _UIntType __f>
  class mersenne_twister_engine {
   ...
   public:
    ...
    template <typename _UIntType1, size_t __w1, size_t __n1, size_t __m1,
              size_t __r1, _UIntType1 __a1, size_t __u1, _UIntType1 __d1,
              size_t __s1, _UIntType1 __b1, size_t __t1, _UIntType1 __c1,
              size_t __l1, _UIntType1 __f1, typename _CharT, typename _Traits>
    friend std::basic_ostream<_CharT, _Traits>& operator<<(
        std::basic_ostream<_CharT, _Traits>& __os,
        const std::mersenne_twister_engine<_UIntType1, __w1, __n1, __m1, __r1,
                                           __a1, __u1, __d1, __s1, __b1, __t1,
                                           __c1, __l1, __f1>& __x);
    ...
    friend std::basic_istream<_CharT, _Traits>& operator>>(
        std::basic_istream<_CharT, _Traits>& __is,
        std::mersenne_twister_engine<_UIntType1, __w1, __n1, __m1, __r1, __a1,
                                     __u1, __d1, __s1, __b1, __t1, __c1, __l1,
                                     __f1>& __x);
  ...
  template <typename _UIntType, size_t __w, size_t __n, size_t __m, size_t __r,
            ...
            size_t __t, _UIntType __c, size_t __l, _UIntType __f>
  inline bool operator!=(
      const std::mersenne_twister_engine<_UIntType, __w, __n, __m, __r, __a,
                                         __u, __d, __s, __b, __t, __c, __l,
                                         __f>& __lhs,
      const std::mersenne_twister_engine<_UIntType, __w, __n, __m, __r, __a,
                                         __u, __d, __s, __b, __t, __c, __l,
                                         __f>& __rhs) {
  ...
  class subtract_with_carry_engine {
   ...
   public:
     ...
     *          would be equal, false otherwise.
     */
    friend bool operator==(const subtract_with_carry_engine& __lhs,
                           const subtract_with_carry_engine& __rhs) {
      return (std::equal(__lhs._M_x, __lhs._M_x + long_lag, __rhs._M_x) &&
              __lhs._M_carry == __rhs._M_carry && __lhs._M_p == __rhs._M_p);
    }
  ...
  inline bool operator!=(
      ...
      const std::subtract_with_carry_engine<_UIntType, __w, __s, __r>& __rhs) {
    return !(__lhs == __rhs);
  }
  ...
  class discard_block_engine {
   ...
   public:
    ...
    template <typename _Sseq>
    using _If_seed_seq =
        typename enable_if<__detail::__is_seed_seq<_Sseq, discard_block_engine,
     ...
     */
    template <typename _Sseq, typename = _If_seed_seq<_Sseq>>
    explicit discard_block_engine(_Sseq& __q) : _M_b(__q), _M_n(0) {}
     ...
     *        object.
     */
    const _RandomNumberEngine& base() const noexcept { return _M_b; }

    /**
     * @brief Gets the minimum value in the generated random number range.
     */
    static constexpr result_type min() { return _RandomNumberEngine::min(); }

    /**
     * @brief Gets the maximum value in the generated random number range.
     */
    static constexpr result_type max() { return _RandomNumberEngine::max(); }
  ...
  inline bool operator!=(
      ...
      const std::discard_block_engine<_RandomNumberEngine, __p, __r>& __rhs) {
    return !(__lhs == __rhs);
  }
  ...
  class independent_bits_engine {
   ...
   public:
     ...
     * @param __rng An existing (base class) engine object.
     */
    explicit independent_bits_engine(const _RandomNumberEngine& __rng)
        : _M_b(__rng) {}
     ...
     * @param __rng An existing (base class) engine object.
     */
    explicit independent_bits_engine(_RandomNumberEngine&& __rng)
        : _M_b(std::move(__rng)) {}
     ...
     */
    template <typename _Sseq, typename = _If_seed_seq<_Sseq>>
    explicit independent_bits_engine(_Sseq& __q) : _M_b(__q) {}
     ...
     *        seed for the underlying base class generator engine.
     */
    void seed(result_type __s) { _M_b.seed(__s); }
     ...
     *          would be equal, false otherwise.
     */
    friend bool operator==(const independent_bits_engine& __lhs,
  ...
  template <typename _RandomNumberEngine, size_t __w, typename _UIntType>
  inline bool operator!=(
      const std::independent_bits_engine<_RandomNumberEngine, __w, _UIntType>&
          __lhs,
      const std::independent_bits_engine<_RandomNumberEngine, __w, _UIntType>&
          __rhs) {
    return !(__lhs == __rhs);
  ...
  class shuffle_order_engine {
   ...
   public:
    ...
    template <typename _Sseq>
    using _If_seed_seq =
        typename enable_if<__detail::__is_seed_seq<_Sseq, shuffle_order_engine,
                                                   result_type>::value>::type;
     ...
     * The underlying engine is default constructed as well.
     */
    shuffle_order_engine() : _M_b() { _M_initialize(); }
     ...
     * @param __rng An existing (base class) engine object.
     */
    explicit shuffle_order_engine(const _RandomNumberEngine& __rng)
        : _M_b(__rng) {
      _M_initialize();
    }
     ...
     * @param __rng An existing (base class) engine object.
     */
    explicit shuffle_order_engine(_RandomNumberEngine&& __rng)
        : _M_b(std::move(__rng)) {
      _M_initialize();
    }
     ...
     */
    template <typename _Sseq, typename = _If_seed_seq<_Sseq>>
    explicit shuffle_order_engine(_Sseq& __q) : _M_b(__q) {
      _M_initialize();
    }
     ...
     *          would be equal, false otherwise.
     */
    friend bool operator==(const shuffle_order_engine& __lhs,
   ...
   private:
    void _M_initialize() {
      for (size_t __i = 0; __i < __k; ++__i) _M_v[__i] = _M_b();
      _M_y = _M_b();
    }
  ...
  inline bool operator!=(
      ...
      const std::shuffle_order_engine<_RandomNumberEngine, __k>& __rhs) {
    return !(__lhs == __rhs);
  }
  ...
  class random_device {
   public:
    ...
    explicit random_device(const std::string& __token) { _M_init(__token); }
  ...
  inline bool operator!=(const std::uniform_int_distribution<_IntType>& __d1,
  ...
  class uniform_real_distribution {
   ...
   public:
    ...
    struct param_type {
      ...
      explicit param_type(_RealType __a, _RealType __b = _RealType(1))
          : _M_a(__a), _M_b(__b) {
   ...
   public:
     ...
     */
    explicit uniform_real_distribution(_RealType __a,
    ...
    result_type operator()(_UniformRandomNumberGenerator& __urng,
      ...
      __detail::_Adaptor<_UniformRandomNumberGenerator, result_type> __aurng(
          __urng);
     ...
     *        the same parameters.
     */
    friend bool operator==(const uniform_real_distribution& __d1,
   ...
   */
  template <typename _IntType>
  inline bool operator!=(const std::uniform_real_distribution<_IntType>& __d1,
  ...
  class normal_distribution {
   ...
   public:
    ...
    struct param_type {
      ...
      explicit param_type(_RealType __mean, _RealType __stddev = _RealType(1))
  ...
  class lognormal_distribution {
   ...
   public:
    ...
    struct param_type {
      ...
      explicit param_type(_RealType __m, _RealType __s = _RealType(1))
          : _M_m(__m), _M_s(__s) {}
    ...
    explicit lognormal_distribution(_RealType __m, _RealType __s = _RealType(1))
     ...
     */
    void reset() { _M_nd.reset(); }

    /**
     *
     */
    _RealType m() const { return _M_param.m(); }

    _RealType s() const { return _M_param.s(); }
     ...
     *        be generated are equal.
     */
    friend bool operator==(const lognormal_distribution& __d1,
   ...
   */
  template <typename _RealType>
  inline bool operator!=(const std::lognormal_distribution<_RealType>& __d1,
  ...
  class gamma_distribution {
   ...
   public:
    ...
    struct param_type {
      ...
      explicit param_type(_RealType __alpha_val,
   ...
   public:
     ...
     */
    explicit gamma_distribution(_RealType __alpha_val,
                                _RealType __beta_val = _RealType(1))
     ...
     */
    _RealType alpha() const { return _M_param.alpha(); }

    /**
     * @brief Returns the @f$\beta@f$ of the distribution.
     */
    _RealType beta() const { return _M_param.beta(); }
     ...
     *        are equal.
     */
    friend bool operator==(const gamma_distribution& __d1,
   ...
   */
  template <typename _RealType>
  inline bool operator!=(const std::gamma_distribution<_RealType>& __d1,
  ...
  class chi_squared_distribution {
   ...
   public:
    ...
    explicit chi_squared_distribution(_RealType __n)
     ...
     * @brief Resets the distribution state.
     */
    void reset() { _M_gd.reset(); }

    /**
     *
     */
    _RealType n() const { return _M_param.n(); }
    ...
    void param(const param_type& __param) {
      _M_param = __param;
      typedef
          typename std::gamma_distribution<result_type>::param_type param_type;
    ...
    void __generate(_ForwardIterator __f, _ForwardIterator __t,
                    _UniformRandomNumberGenerator& __urng,
                    const param_type& __p) {
      typename std::gamma_distribution<result_type>::param_type __p2(__p.n() /
                                                                     2);
     ...
     *        generated are equal.
     */
    friend bool operator==(const chi_squared_distribution& __d1,
   ...
   private:
    ...
    void __generate_impl(
        ...
        _UniformRandomNumberGenerator& __urng,
        const typename std::gamma_distribution<result_type>::param_type& __p);
   ...
   */
  template <typename _RealType>
  inline bool operator!=(const std::chi_squared_distribution<_RealType>& __d1,
  ...
  class cauchy_distribution {
   ...
   public:
    ...
    explicit cauchy_distribution(_RealType __a, _RealType __b = 1.0)
        : _M_param(__a, __b) {}
     ...
     *
     */
    _RealType a() const { return _M_param.a(); }

    _RealType b() const { return _M_param.b(); }
     ...
     *        the same parameters.
     */
    friend bool operator==(const cauchy_distribution& __d1,
   ...
   */
  template <typename _RealType>
  inline bool operator!=(const std::cauchy_distribution<_RealType>& __d1,
  ...
  class fisher_f_distribution {
   ...
   public:
    ...
    struct param_type {
      ...
      explicit param_type(_RealType __m, _RealType __n = _RealType(1))
          : _M_m(__m), _M_n(__n) {}
    ...
    explicit fisher_f_distribution(_RealType __m, _RealType __n = _RealType(1))
     ...
     *        be generated are equal.
     */
    friend bool operator==(const fisher_f_distribution& __d1,
                           const fisher_f_distribution& __d2) {
      return (__d1._M_param == __d2._M_param && __d1._M_gd_x == __d2._M_gd_x &&
   ...
   */
  template <typename _RealType>
  inline bool operator!=(const std::fisher_f_distribution<_RealType>& __d1,
  ...
  class student_t_distribution {
   ...
   public:
    ...
    explicit student_t_distribution(_RealType __n)
     ...
     *        be generated are equal.
     */
    friend bool operator==(const student_t_distribution& __d1,
   ...
   */
  template <typename _RealType>
  inline bool operator!=(const std::student_t_distribution<_RealType>& __d1,
  ...
  class bernoulli_distribution {
   ...
   public:
     ...
     *        the same parameters.
     */
    friend bool operator==(const bernoulli_distribution& __d1,
   ...
   *        different parameters.
   */
  inline bool operator!=(const std::bernoulli_distribution& __d1,
  ...
  inline std::basic_istream<_CharT, _Traits>& operator>>(
    ...
    double __p;
    if (__is >> __p) __x.param(bernoulli_distribution::param_type(__p));
    return __is;
  }
  ...
  class binomial_distribution {
   ...
   public:
    ...
    struct param_type {
      ...
      explicit param_type(_IntType __t, double __p = 0.5)
          : _M_t(__t), _M_p(__p) {
        __glibcxx_assert((_M_t >= _IntType(0)) && (_M_p >= 0.0) &&
                         (_M_p <= 1.0));
        _M_initialize();
      }
     ...
     private:
      ...
      double _M_d1, _M_d2, _M_s1, _M_s2, _M_c, _M_a1, _M_a123, _M_s, _M_lf,
          _M_lp1p;
#endif
      bool _M_easy;
    };
    ...
    explicit binomial_distribution(_IntType __t, double __p = 0.5)
        : _M_param(__t, __p), _M_nd() {}

    explicit binomial_distribution(const param_type& __p)
        : _M_param(__p), _M_nd() {}
     ...
     */
    _IntType t() const { return _M_param.t(); }
     ...
     * @brief Returns the least upper bound value of the distribution.
     */
    result_type max() const { return _M_param.t(); }
   ...
   private:
    ...
    template <typename _UniformRandomNumberGenerator>
    result_type _M_waiting(_UniformRandomNumberGenerator& __urng, _IntType __t,
                           double __q);
   ...
   */
  template <typename _IntType>
  inline bool operator!=(const std::binomial_distribution<_IntType>& __d1,
  ...
  class geometric_distribution {
   ...
   public:
    ...
    struct param_type {
     ...
     private:
      void _M_initialize() { _M_log_1_p = std::log(1.0 - _M_p); }
     ...
     *        the same parameters.
     */
    friend bool operator==(const geometric_distribution& __d1,
   ...
   */
  template <typename _IntType>
  inline bool operator!=(const std::geometric_distribution<_IntType>& __d1,
  ...
  class negative_binomial_distribution {
   ...
   public:
    ...
    struct param_type {
      ...
      explicit param_type(_IntType __k, double __p = 0.5)
          : _M_k(__k), _M_p(__p) {
    ...
    explicit negative_binomial_distribution(_IntType __k, double __p = 0.5)
        : _M_param(__k, __p), _M_gd(__k, (1.0 - __p) / __p) {}

    explicit negative_binomial_distribution(const param_type& __p)
     ...
     */
    _IntType k() const { return _M_param.k(); }
     ...
     *        generated are equal.
     */
    friend bool operator==(const negative_binomial_distribution& __d1,
  ...
  class poisson_distribution {
   ...
   public:
    ...
    explicit poisson_distribution(const param_type& __p)
        : _M_param(__p), _M_nd() {}
     ...
     */
    double mean() const { return _M_param.mean(); }
     ...
     *        are equal.
     */
    friend bool operator==(const poisson_distribution& __d1,
   ...
   */
  template <typename _IntType>
  inline bool operator!=(const std::poisson_distribution<_IntType>& __d1,
  ...
  class exponential_distribution {
   ...
   public:
     ...
     */
    explicit exponential_distribution(_RealType __lambda)
        : _M_param(__lambda) {}
     ...
     */
    _RealType lambda() const { return _M_param.lambda(); }
     ...
     *        parameters.
     */
    friend bool operator==(const exponential_distribution& __d1,
   ...
   */
  template <typename _RealType>
  inline bool operator!=(const std::exponential_distribution<_RealType>& __d1,
  ...
  class weibull_distribution {
   ...
   public:
    ...
    struct param_type {
      ...
      explicit param_type(_RealType __a, _RealType __b = _RealType(1.0))
          : _M_a(__a), _M_b(__b) {}
    ...
    explicit weibull_distribution(_RealType __a, _RealType __b = _RealType(1))
        : _M_param(__a, __b) {}
     ...
     *        parameters.
     */
    friend bool operator==(const weibull_distribution& __d1,
   ...
   */
  template <typename _RealType>
  inline bool operator!=(const std::weibull_distribution<_RealType>& __d1,
  ...
  class extreme_value_distribution {
   ...
   public:
    ...
    explicit extreme_value_distribution(_RealType __a,
                                        _RealType __b = _RealType(1))
        : _M_param(__a, __b) {}
     ...
     *        parameters.
     */
    friend bool operator==(const extreme_value_distribution& __d1,
  ...
  class discrete_distribution {
   ...
   public:
     ...
     */
    std::vector<double> probabilities() const {
      return _M_param._M_prob.empty() ? std::vector<double>(1, 1.0)
                                      : _M_param._M_prob;
    }
    ...
    result_type max() const {
      return _M_param._M_prob.empty()
                 ? result_type(0)
                 : result_type(_M_param._M_prob.size() - 1);
    }
     ...
     *        parameters.
     */
    friend bool operator==(const discrete_distribution& __d1,
   ...
   */
  template <typename _IntType>
  inline bool operator!=(const std::discrete_distribution<_IntType>& __d1,
  ...
  class piecewise_constant_distribution {
   ...
   public:
     ...
     */
    std::vector<double> densities() const {
      return _M_param._M_den.empty() ? std::vector<double>(1, 1.0)
                                     : _M_param._M_den;
    }
     ...
     *        same parameters.
     */
    friend bool operator==(const piecewise_constant_distribution& __d1,
  ...
  class piecewise_linear_distribution {
   ...
   public:
     ...
     */
    std::vector<double> densities() const {
      return _M_param._M_den.empty() ? std::vector<double>(2, 1.0)
                                     : _M_param._M_den;
    }
     ...
     *        same parameters.
     */
    friend bool operator==(const piecewise_linear_distribution& __d1,
  ...
  class seed_seq {
   public:
    ...
    // property functions
    size_t size() const noexcept { return _M_v.size(); }
