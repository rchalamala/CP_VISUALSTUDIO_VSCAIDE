...
namespace std _GLIBCXX_VISIBILITY(default) {
  ...
  struct _RefFunClos<_Expr, _Dom>
    ...
    _RefFunClos(const _Dom& __e, _Tp __f(const _Tp&)) : _Base(__e, __f) {}
  };
  ...
  class _UnBase {
   public:
    ...
    value_type operator[](size_t __i) const { return _Oper()(_M_expr[__i]); }
  ...
  struct _BinClos<_Oper, _Expr, _ValArray, _Dom, typename _Dom::value_type>
    ...
    _BinClos(const _Dom& __e1, const valarray<_Tp>& __e2) : _Base(__e1, __e2) {}
  };
  ...
  struct _BinClos<_Oper, _ValArray, _Expr, typename _Dom::value_type, _Dom>
    ...
    _BinClos(const valarray<_Tp>& __e1, const _Dom& __e2) : _Base(__e1, __e2) {}
  };
  ...
  class _SBase {
   public:
    ...
    _SBase(const _Dom& __e, const slice& __s) : _M_expr(__e), _M_slice(__s) {}
  ...
  class _SBase<_Array<_Tp> > {
   public:
    ...
    _SBase(_Array<_Tp> __a, const slice& __s)
        : _M_array(__a._M_data + __s.start()),
          _M_size(__s.size()),
