...
namespace std _GLIBCXX_VISIBILITY(default) {
  ...
  class _GBase {
   public:
    ...
    value_type operator[](size_t __i) const { return _M_expr[_M_index[__i]]; }
  ...
  struct _GClos<_Expr, _Dom> : _GBase<_Dom> {
    ...
    _GClos(const _Dom& __e, const valarray<size_t>& __i) : _Base(__e, __i) {}
  };
  ...
  struct _GClos<_ValArray, _Tp> : _GBase<_Array<_Tp> > {
    ...
    _GClos(_Array<_Tp> __a, const valarray<size_t>& __i) : _Base(__a, __i) {}
  };
  ...
  struct _IClos<_Expr, _Dom> : _IBase<_Dom> {
    ...
    _IClos(const _Dom& __e, const valarray<size_t>& __i) : _Base(__e, __i) {}
  };
  ...
  class _Expr {
   public:
    ...
    _Expr<_UnClos<__unary_plus, std::_Expr, _Clos>, value_type> operator+()
        const;

    _Expr<_UnClos<__negate, std::_Expr, _Clos>, value_type> operator-() const;

    _Expr<_UnClos<__bitwise_not, std::_Expr, _Clos>, value_type> operator~()
        const;
  ...
  template <class _Clos, typename _Tp>
  inline _Expr<_Clos, _Tp>::_Expr(const _Clos& __c) : _M_closure(__c) {}
  ...
  template <class _Clos, typename _Tp>
  inline valarray<_Tp> _Expr<_Clos, _Tp>::operator[](const valarray<bool>& __m)
      const {
  ...
  template <class _Clos, typename _Tp>
  inline valarray<_Tp> _Expr<_Clos, _Tp>::operator[](
...
#define _DEFINE_EXPR_BINARY_OPERATOR(_Op, _Name)                               \
  ...
  template <class _Dom>                                                        \
  inline _Expr<                                                                \
      _BinClos<_Name, _Expr, _Constant, _Dom, typename _Dom::value_type>,      \
  ...
  template <class _Dom>                                                        \
  inline _Expr<                                                                \
      _BinClos<_Name, _Constant, _Expr, typename _Dom::value_type, _Dom>,      \
      typename __fun<_Name, typename _Dom::value_type>::result_type>           \
  ...
  template <class _Dom>                                                        \
  inline _Expr<                                                                \
      _BinClos<_Name, _Expr, _ValArray, _Dom, typename _Dom::value_type>,      \
      typename __fun<_Name, typename _Dom::value_type>::result_type>           \
  ...
  template <class _Dom>                                                        \
  inline _Expr<                                                                \
      _BinClos<_Name, _ValArray, _Expr, typename _Dom::value_type, _Dom>,      \
      typename __fun<_Name, typename _Dom::value_type>::result_type>           \
...
#define _DEFINE_EXPR_UNARY_FUNCTION(_Name, _UName)                             \
  template <class _Dom>                                                        \
  inline _Expr<_UnClos<_UName, _Expr, _Dom>, typename _Dom::value_type> _Name( \
      const _Expr<_Dom, typename _Dom::value_type>& __e) {                     \
    typedef typename _Dom::value_type _Tp;                                     \
    ...
    return _Expr<_Closure, _Tp>(_Closure(__e()));                              \
                                                                               ...
                                                                               \
  template <typename _Tp>                                                      \
  inline _Expr<_UnClos<_UName, _ValArray, _Tp>, _Tp> _Name(                    \
...
#define _DEFINE_EXPR_BINARY_FUNCTION(_Fun, _UFun)                          \
  ...
  template <class _Dom>                                                    \
  inline _Expr<                                                            \
      _BinClos<_UFun, _Expr, _ValArray, _Dom, typename _Dom::value_type>,  \
  ...
  template <class _Dom>                                                    \
  inline _Expr<                                                            \
      _BinClos<_UFun, _ValArray, _Expr, typename _Dom::value_type, _Dom>,  \
      typename _Dom::value_type>                                           \
  ...
  template <class _Dom>                                                    \
  inline _Expr<                                                            \
      _BinClos<_UFun, _Expr, _Constant, _Dom, typename _Dom::value_type>,  \
      typename _Dom::value_type>                                           \
  _Fun(const _Expr<_Dom, typename _Dom::value_type>& __e,                  \
       const typename _Dom::value_type& __t) {                             \
    typedef typename _Dom::value_type _Tp;                                 \
  ...
  template <class _Dom>                                                    \
  inline _Expr<                                                            \
      _BinClos<_UFun, _Constant, _Expr, typename _Dom::value_type, _Dom>,  \
      typename _Dom::value_type>                                           \
  _Fun(const typename _Dom::value_type& __t,                               \
    ...
    return _Expr<_Closure, _Tp>(_Closure(__t, __e()));                     \
                                                                           ...
                                                                           \
  template <typename _Tp>                                                  \
  inline _Expr<_BinClos<_UFun, _ValArray, _ValArray, _Tp, _Tp>, _Tp> _Fun( \
    ...
    return _Expr<_Closure, _Tp>(_Closure(__v, __w));                       \
                                                                           ...
                                                                           \
  template <typename _Tp>                                                  \
  inline _Expr<_BinClos<_UFun, _ValArray, _Constant, _Tp, _Tp>, _Tp> _Fun( \
      const valarray<_Tp>& __v,                                            \
    ...
    return _Expr<_Closure, _Tp>(_Closure(__v, __t));                       \
                                                                           ...
                                                                           \
  template <typename _Tp>                                                  \
  inline _Expr<_BinClos<_UFun, _Constant, _ValArray, _Tp, _Tp>, _Tp> _Fun( \
      const typename valarray<_Tp>::value_type& __t,                       \
      const valarray<_Tp>& __v) {                                          \
