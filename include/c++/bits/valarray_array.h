...
namespace std _GLIBCXX_VISIBILITY(default) {
  ...
  _Tp* __valarray_get_storage(size_t) __attribute__((__malloc__));

  template <typename _Tp>
  inline _Tp* __valarray_get_storage(size_t __n) {
    return static_cast<_Tp*>(operator new(__n * sizeof(_Tp)));
  }

  // Return memory to the system
  inline void __valarray_release_memory(void* __p) { operator delete(__p); }
  ...
  struct _Array_copy_ctor<_Tp, true> {
    inline static void _S_do_it(const _Tp* __b, const _Tp* __e,
                                _Tp* __restrict__ __o) {
      if (__b) __builtin_memcpy(__o, __b, (__e - __b) * sizeof(_Tp));
    }
  };
  ...
  template <typename _Tp>
  inline void __valarray_copy_construct(const _Tp* __restrict__ __a, size_t __n,
  ...
  inline void __valarray_fill(_Tp * __restrict__ __a,
                              const size_t* __restrict__ __i, size_t __n,
                              const _Tp& __t) {
  ...
  struct _Array_copier<_Tp, true> {
    inline static void _S_do_it(const _Tp* __restrict__ __a, size_t __n,
                                _Tp* __restrict__ __b) {
      if (__n != 0) __builtin_memcpy(__b, __a, __n * sizeof(_Tp));
    }
  };
  ...
  inline void __valarray_copy(const _Tp* __restrict__ __src, size_t __n,
                              size_t __s1, _Tp* __restrict__ __dst,
                              size_t __s2) {
  ...
  template <typename _Tp>
  inline void __valarray_copy(
      const _Tp* __restrict__ __src, size_t __n, const size_t* __restrict__ __i,
      _Tp* __restrict__ __dst, const size_t* __restrict__ __j) {
    for (size_t __k = 0; __k < __n; ++__k) __dst[*__j++] = __src[*__i++];
  }
  ...
  template <typename _Tp>
  inline void __valarray_copy_construct(_Array<_Tp> __a, size_t __n, size_t __s,
                                        _Array<_Tp> __b) {
  ...
  // another indexed array __dst[<__j>].
  template <typename _Tp>
  inline void __valarray_copy(_Array<_Tp> __src, size_t __n, _Array<size_t> __i,
  ...
  template <typename _Tp>
  inline _Array<_Tp>::_Array(_Tp* const __restrict__ __p) : _M_data(__p) {}

  template <typename _Tp>
  inline _Array<_Tp>::_Array(const valarray<_Tp>& __v) : _M_data(__v._M_data) {}
...
#define _DEFINE_ARRAY_FUNCTION(_Op, _Name)                                    \
  template <typename _Tp>                                                     \
  inline void _Array_augmented_##_Name(_Array<_Tp> __a, size_t __n,           \
                                       const _Tp& __t) {                      \
  ...
  void _Array_augmented_##_Name(_Array<_Tp> __a, const _Expr<_Dom, _Tp>& __e, \
                                size_t __n) {                                 \
    _Tp* __p(__a._M_data);                                                    \
  ...
  inline void _Array_augmented_##_Name(_Array<_Tp> __a, size_t __n,           \
    ...
    for (_Tp* __p = __a._M_data; __p < __a._M_data + __s * __n;               \
      ...
      *__p _Op## = *__q;                                                      \
                                                                              ...
                                                                              \
  template <typename _Tp>                                                     \
  inline void _Array_augmented_##_Name(_Array<_Tp> __a, _Array<_Tp> __b,      \
    ...
    for (_Tp* __p = __a._M_data; __p < __a._M_data + __n; ++__p, __q += __s)  \
      *__p _Op## = *__q;                                                      \
                                                                              ...
                                                                              \
  template <typename _Tp, class _Dom>                                         \
  void _Array_augmented_##_Name(_Array<_Tp> __a, size_t __s,                  \
    ...
    for (size_t __i = 0; __i < __n; ++__i, __p += __s) *__p _Op## = __e[__i]; \
                                                                              ...
                                                                              \
  template <typename _Tp>                                                     \
  inline void _Array_augmented_##_Name(_Array<_Tp> __a, _Array<size_t> __i,   \
                                       _Array<_Tp> __b, size_t __n) {         \
    _Tp* __q(__b._M_data);                                                    \
  ...
  inline void _Array_augmented_##_Name(_Array<_Tp> __a, size_t __n,           \
    ...
    for (size_t* __j = __i._M_data; __j < __i._M_data + __n; ++__j, ++__p)    \
      *__p _Op## = __b._M_data[*__j];                                         \
                                                                              ...
                                                                              \
  template <typename _Tp, class _Dom>                                         \
  void _Array_augmented_##_Name(_Array<_Tp> __a, _Array<size_t> __i,          \
                                const _Expr<_Dom, _Tp>& __e, size_t __n) {    \
    ...
    for (size_t __k = 0; __k < __n; ++__k, ++__j)                             \
      __a._M_data[*__j] _Op## = __e[__k];                                     \
                                                                              ...
                                                                              \
  template <typename _Tp>                                                     \
  void _Array_augmented_##_Name(_Array<_Tp> __a, _Array<bool> __m,            \
                                _Array<_Tp> __b, size_t __n) {                \
    ...
    for (_Tp* __q = __b._M_data; __q < __b._M_data + __n;                     \
      ...
      *__p _Op## = *__q;                                                      \
                                                                              ...
                                                                              \
  template <typename _Tp>                                                     \
  void _Array_augmented_##_Name(_Array<_Tp> __a, size_t __n, _Array<_Tp> __b, \
                                _Array<bool> __m) {                           \
    bool* __ok(__m._M_data);                                                  \
    _Tp* __q(__b._M_data);                                                    \
