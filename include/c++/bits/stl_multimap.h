...
namespace std _GLIBCXX_VISIBILITY(default) {
  ...
  class multimap {
   ...
   private:
    ...
    __glibcxx_class_requires(_Tp, _SGIAssignableConcept)
        ...
        __glibcxx_class_requires4(
            _Compare, bool, _Key, _Key,
            _BinaryFunctionConcept) __glibcxx_class_requires2(value_type,
                                                              _Alloc_value_type,
                                                              _SameTypeConcept)
#endif
   ...
   public:
    ...
    multimap(multimap&& __m, const allocator_type& __a) noexcept(
  ...
  multimap(_InputIterator, _InputIterator, _Compare = _Compare(),
  ...
  template <typename _Key, typename _Tp, typename _Compare = less<_Key>,
            ...
            typename = _RequireNotAllocator<_Compare>,
            typename = _RequireAllocator<_Allocator>>
  multimap(initializer_list<pair<_Key, _Tp>>, _Compare = _Compare(),
           _Allocator = _Allocator())
  ...
  struct _Rb_tree_merge_helper<
      _GLIBCXX_STD_C::multimap<_Key, _Val, _Cmp1, _Alloc>, _Cmp2> {
   private:
