  ...
  struct _Vector_base {
    ...
    struct _Vector_impl : public _Tp_alloc_type, public _Vector_impl_data {
      ...
      struct _Asan<allocator<_Up>> {
        ...
        static void _S_adjust(_Vector_impl& __impl, pointer __prev,
                              pointer __curr) {
          __sanitizer_annotate_contiguous_container(
              __impl._M_start, __impl._M_end_of_storage, __prev, __curr);
        }

        static void _S_grow(_Vector_impl& __impl, size_type __n) {
        ...
        static void _S_on_dealloc(_Vector_impl& __impl) {
          if (__impl._M_start)
