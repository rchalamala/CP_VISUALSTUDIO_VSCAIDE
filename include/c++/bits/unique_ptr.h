...
#pragma GCC diagnostic pop
  ...
  _GLIBCXX_NODISCARD inline bool operator==(const unique_ptr<_Tp, _Dp>& __x,
  ...
  /// unique_ptr comparison with nullptr
  template <typename _Tp, typename _Dp>
  _GLIBCXX_NODISCARD inline bool operator==(
  ...
  /// unique_ptr comparison with nullptr
  template <typename _Tp, typename _Dp>
  _GLIBCXX_NODISCARD inline bool operator<(nullptr_t,
  ...
  requires three_way_comparable_with<
      ...
      typename unique_ptr<_Up, _Ep>::
          pointer> inline compare_three_way_result_t<typename unique_ptr<_Tp,
                                                                         _Dp>::
                                                         pointer,
                                                     typename unique_ptr<
                                                         _Up, _Ep>::pointer>
