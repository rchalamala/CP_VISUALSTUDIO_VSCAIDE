...
class F32vec4 {
 ...
 public:
  ...
  friend float add_horizontal(F32vec4 &a) {
    F32vec4 ftemp = _mm_add_ss(
        a, _mm_add_ss(
               _mm_shuffle_ps(a, a, 1),
               _mm_add_ss(_mm_shuffle_ps(a, a, 2), _mm_shuffle_ps(a, a, 3))));
    return ftemp[0];
  }
...
#define Fvec32s4_COMP(op)                                      \
  friend F32vec4 cmp##op(const F32vec4 &a, const F32vec4 &b) { \
    return _mm_cmp##op##_ps(a, b);                             \
  }
  Fvec32s4_COMP(eq) Fvec32s4_COMP(lt) Fvec32s4_COMP(le) Fvec32s4_COMP(gt)
      Fvec32s4_COMP(ge) Fvec32s4_COMP(neq) Fvec32s4_COMP(nlt) Fvec32s4_COMP(nle)
          Fvec32s4_COMP(ngt) Fvec32s4_COMP(nge)
#undef Fvec32s4_COMP
...
Fvec32s4_SELECT(eq) Fvec32s4_SELECT(lt) Fvec32s4_SELECT(le) Fvec32s4_SELECT(gt)
    Fvec32s4_SELECT(ge) Fvec32s4_SELECT(neq) Fvec32s4_SELECT(nlt)
        Fvec32s4_SELECT(nle) Fvec32s4_SELECT(ngt) Fvec32s4_SELECT(nge)
...
class F32vec1 {
 ...
 public:
  ...
  friend F32vec1 rcp_nr(const F32vec1 &a) {
    ...
    return _mm_sub_ss(_mm_add_ss(Ra0, Ra0),
                      _mm_mul_ss(_mm_mul_ss(Ra0, a), Ra0));
  }
...
#define Fvec32s1_COMP(op)                                      \
  friend F32vec1 cmp##op(const F32vec1 &a, const F32vec1 &b) { \
    return _mm_cmp##op##_ss(a, b);                             \
  }
  Fvec32s1_COMP(eq) Fvec32s1_COMP(lt) Fvec32s1_COMP(le) Fvec32s1_COMP(gt)
      Fvec32s1_COMP(ge) Fvec32s1_COMP(neq) Fvec32s1_COMP(nlt) Fvec32s1_COMP(nle)
          Fvec32s1_COMP(ngt) Fvec32s1_COMP(nge)
#undef Fvec32s1_COMP
...
Fvec32s1_SELECT(eq) Fvec32s1_SELECT(lt) Fvec32s1_SELECT(le) Fvec32s1_SELECT(gt)
    Fvec32s1_SELECT(ge) Fvec32s1_SELECT(neq) Fvec32s1_SELECT(nlt)
        Fvec32s1_SELECT(nle) Fvec32s1_SELECT(ngt) Fvec32s1_SELECT(nge)
