...
_CRTIMP errno_t __cdecl _get_tzname(size_t *_ReturnValue, char *_Buffer,
                                    size_t _SizeInBytes, int _Index);
char *__cdecl asctime(const struct tm *_Tm) __MINGW_ATTRIB_DEPRECATED_SEC_WARN;
_SECIMP errno_t __cdecl asctime_s(char *_Buf, size_t _SizeInWords,
                                  const struct tm *_Tm);
_CRTIMP char *__cdecl _ctime32(const __time32_t *_Time)
    __MINGW_ATTRIB_DEPRECATED_SEC_WARN;
_SECIMP errno_t __cdecl _ctime32_s(char *_Buf, size_t _SizeInBytes,
...
size_t __cdecl strftime(char *__restrict__ _Buf, size_t _SizeInBytes,
                        const char *__restrict__ _Format,
                        const struct tm *__restrict__ _Tm);
_CRTIMP size_t __cdecl _strftime_l(char *__restrict__ _Buf, size_t _Max_size,
                                   const char *__restrict__ _Format,
                                   const struct tm *__restrict__ _Tm,
                                   _locale_t _Locale);
...
_CRTIMP char *__cdecl _ctime64(const __time64_t *_Time)
    __MINGW_ATTRIB_DEPRECATED_SEC_WARN;
_SECIMP errno_t __cdecl _ctime64_s(char *_Buf, size_t _SizeInBytes,
...
static __inline errno_t __CRTDECL gmtime_s(struct tm *_Tm,
                                           const time_t *_Time) {
...
static __inline errno_t __CRTDECL ctime_s(char *_Buf, size_t _SizeInBytes,
                                          const time_t *_Time) {
...
__forceinline struct tm *__CRTDECL gmtime_r(const time_t *_Time,
                                            struct tm *_Tm) {
