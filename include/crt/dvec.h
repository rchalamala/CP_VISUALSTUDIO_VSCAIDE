...
class Is32vec4 : public I32vec4 {
 public:
  ...
  friend std::ostream &operator<<(std::ostream &os, const Is32vec4 &a) {
    os << "[3]:" << _MM_4DW(3, a) << " [2]:" << _MM_4DW(2, a)
       << " [1]:" << _MM_4DW(1, a) << " [0]:" << _MM_4DW(0, a);
    return os;
  }
#endif
...
class Iu32vec4 : public I32vec4 {
 public:
  ...
  Iu32vec4(unsigned int ui3, unsigned int ui2, unsigned int ui1,
           unsigned int ui0) {
    _MM_4UDW(0, vec) = ui0;
    _MM_4UDW(1, vec) = ui1;
    _MM_4UDW(2, vec) = ui2;
  ...
  friend std::ostream &operator<<(std::ostream &os, const Iu32vec4 &a) {
    os << "[3]:" << _MM_4UDW(3, a) << " [2]:" << _MM_4UDW(2, a)
       << " [1]:" << _MM_4UDW(1, a) << " [0]:" << _MM_4UDW(0, a);
    return os;
  }
#endif
...
class Is16vec8 : public I16vec8 {
 public:
  ...
  Is16vec8(signed short s7, signed short s6, signed short s5, signed short s4,
           signed short s3, signed short s2, signed short s1, signed short s0) {
    _MM_8W(0, vec) = s0;
    _MM_8W(1, vec) = s1;
    _MM_8W(2, vec) = s2;
    _MM_8W(3, vec) = s3;
  ...
  friend std::ostream &operator<<(std::ostream &os, const Is16vec8 &a) {
    os << "[7]:" << _MM_8W(7, a) << " [6]:" << _MM_8W(6, a)
       << " [5]:" << _MM_8W(5, a) << " [4]:" << _MM_8W(4, a)
       << " [3]:" << _MM_8W(3, a) << " [2]:" << _MM_8W(2, a)
       << " [1]:" << _MM_8W(1, a) << " [0]:" << _MM_8W(0, a);
    return os;
  }
#endif
...
class Is8vec16 : public I8vec16 {
 public:
  ...
  friend std::ostream &operator<<(std::ostream &os, const Is8vec16 &a) {
    os << "[15]:" << short(_MM_16B(15, a)) << " [14]:" << short(_MM_16B(14, a))
       << " [13]:" << short(_MM_16B(13, a)) << " [12]:" << short(_MM_16B(12, a))
       << " [11]:" << short(_MM_16B(11, a)) << " [10]:" << short(_MM_16B(10, a))
       << " [9]:" << short(_MM_16B(9, a)) << " [8]:" << short(_MM_16B(8, a))
       << " [7]:" << short(_MM_16B(7, a)) << " [6]:" << short(_MM_16B(6, a))
       << " [5]:" << short(_MM_16B(5, a)) << " [4]:" << short(_MM_16B(4, a))
       << " [3]:" << short(_MM_16B(3, a)) << " [2]:" << short(_MM_16B(2, a))
       << " [1]:" << short(_MM_16B(1, a)) << " [0]:" << short(_MM_16B(0, a));
    return os;
  }
#endif
...
#define IVEC128_LOGICALS(vect, element)                                    \
  inline I##vect##vec##element operator&(const I##vect##vec##element &a,   \
                                         const I##vect##vec##element &b) { \
    return _mm_and_si128(a, b);                                            \
  }                                                                        \
  inline I##vect##vec##element operator|(const I##vect##vec##element &a,   \
                                         const I##vect##vec##element &b) { \
  ...
  inline I##vect##vec##element andnot(const I##vect##vec##element &a,      \
                                      const I##vect##vec##element &b) {    \
    return _mm_andnot_si128(a, b);                                         \
  }
...
#define IVEC128_SELECT(vect12, vect34, element, selop, arg1, arg2)          \
  inline I##vect34##vec##element select_##selop(                            \
      const I##vect12##vec##element &a, const I##vect12##vec##element &b,   \
      const I##vect34##vec##element &c, const I##vect34##vec##element &d) { \
    I##vect12##vec##element mask = cmp##selop(a, b);                        \
    return (I##vect34##vec##element(                                        \
        (mask & arg1) |                                                     \
        I##vect12##vec##element((_mm_andnot_si128(mask, arg2)))));          \
  }
...
#define F64vec2_COMP(op)                                       \
  friend F64vec2 cmp##op(const F64vec2 &a, const F64vec2 &b) { \
    return _mm_cmp##op##_pd(a, b);                             \
  }
  F64vec2_COMP(eq) F64vec2_COMP(lt) F64vec2_COMP(le) F64vec2_COMP(gt)
      F64vec2_COMP(ge) F64vec2_COMP(ngt) F64vec2_COMP(nge) F64vec2_COMP(neq)
          F64vec2_COMP(nlt) F64vec2_COMP(nle)
#undef F64vec2_COMP
...
#define F64vec2_COMI(op)                                    \
  friend int comi##op(const F64vec2 &a, const F64vec2 &b) { \
    return _mm_comi##op##_sd(a, b);                         \
  }
  F64vec2_COMI(eq) F64vec2_COMI(lt) F64vec2_COMI(le) F64vec2_COMI(gt)
      F64vec2_COMI(ge) F64vec2_COMI(neq)
#undef F64vec2_COMI

#define F64vec2_UCOMI(op)                                    \
  friend int ucomi##op(const F64vec2 &a, const F64vec2 &b) { \
    return _mm_ucomi##op##_sd(a, b);                         \
  }
          F64vec2_UCOMI(eq) F64vec2_UCOMI(lt) F64vec2_UCOMI(le)
              F64vec2_UCOMI(gt) F64vec2_UCOMI(ge) F64vec2_UCOMI(neq)
#undef F64vec2_UCOMI

#if defined(_ENABLE_VEC_DEBUG)

                  friend std::ostream &
                  operator<<(std::ostream &os, const F64vec2 &a) {
    double *dp = (double *)&a;
    os << " [1]:" << *(dp + 1) << " [0]:" << *dp;
    return os;
  }
...
#define F64vec2_SELECT(op)                                         \
  inline F64vec2 select_##op(const F64vec2 &a, const F64vec2 &b,   \
                             const F64vec2 &c, const F64vec2 &d) { \
    F64vec2 mask = _mm_cmp##op##_pd(a, b);                         \
    return ((mask & c) | F64vec2((_mm_andnot_pd(mask, d))));       \
  }
F64vec2_SELECT(eq) F64vec2_SELECT(lt) F64vec2_SELECT(le) F64vec2_SELECT(gt)
    F64vec2_SELECT(ge) F64vec2_SELECT(neq) F64vec2_SELECT(nlt)
        F64vec2_SELECT(nle)
