...
_CRTIMP int __cdecl _chsize(int _FileHandle,
                            long _Size) __MINGW_ATTRIB_DEPRECATED_SEC_WARN;
...
_CRTIMP int __cdecl _pipe(int *_PtHandles, unsigned int _PipeSize,
                          int _TextMode);
#endif /* _CRT_USE_WINAPI_FAMILY_DESKTOP_APP */
_CRTIMP int __cdecl _read(int _FileHandle, void *_DstBuf,
...
_CRTIMP int __cdecl _write(int _FileHandle, const void *_Buf,
                           unsigned int _MaxCharCount);
...
__CRT_INLINE intptr_t __cdecl _findfirst64i32(
    const char *_Filename, struct _finddata64i32_t *_FindData) {
...
#endif /* __CRT__NO_INLINE */
__MINGW_EXTENSION __int64 __cdecl _lseeki64(int _FileHandle, __int64 _Offset,
                                            int _Origin);
...
_SECIMP errno_t __cdecl _sopen_s(int *_FileHandle, const char *_Filename,
...
#ifndef NO_OLDNAMES
int __cdecl access(const char *_Filename,
                   int _AccessMode) __MINGW_ATTRIB_DEPRECATED_MSVC2005;
int __cdecl chmod(const char *_Filename,
                  int _AccessMode) __MINGW_ATTRIB_DEPRECATED_MSVC2005;
int __cdecl chsize(int _FileHandle,
                   long _Size) __MINGW_ATTRIB_DEPRECATED_MSVC2005;
int __cdecl close(int _FileHandle) __MINGW_ATTRIB_DEPRECATED_MSVC2005;
int __cdecl creat(const char *_Filename,
                  int _PermissionMode) __MINGW_ATTRIB_DEPRECATED_MSVC2005;
int __cdecl dup(int _FileHandle) __MINGW_ATTRIB_DEPRECATED_MSVC2005;
int __cdecl dup2(int _FileHandleSrc,
                 int _FileHandleDst) __MINGW_ATTRIB_DEPRECATED_MSVC2005;
...
int __cdecl locking(int _FileHandle, int _LockMode,
                    long _NumOfBytes) __MINGW_ATTRIB_DEPRECATED_MSVC2005;
long __cdecl lseek(int _FileHandle, long _Offset,
                   int _Origin) __MINGW_ATTRIB_DEPRECATED_MSVC2005;
...
int __cdecl read(int _FileHandle, void *_DstBuf,
                 unsigned int _MaxCharCount) __MINGW_ATTRIB_DEPRECATED_MSVC2005;
int __cdecl setmode(int _FileHandle,
                    int _Mode) __MINGW_ATTRIB_DEPRECATED_MSVC2005;
...
__mingw_bos_extern_ovr int _read(int __fh, void *__dst, unsigned int __n) {
  __mingw_bos_ptr_chk_warn(__dst, __n, 0);
  return __mingw_call__read(__fh, __dst, __n);
}

#ifndef NO_OLDNAMES
__mingw_bos_extern_ovr int read(int __fh, void *__dst, unsigned int __n) {
...
__mingw_bos_extern_ovr int _open(const char *__filename, int __flags, ...) {
...
_CRTIMP int __cdecl __mingw_call__sopen_warn_missing(
    const char *, int, int, ...) __MINGW_ASM_CRT_CALL(_sopen)
    __attribute__((__warning__("_sopen(..._O_CREAT...): missing argument")));

__mingw_bos_extern_ovr int _sopen(const char *__filename, int __flags,
                                  int __share, ...) {
  if (__builtin_va_arg_pack_len() > 1)
...
_CRTIMP int __cdecl __mingw_call__wopen_warn_missing(
    const wchar_t *, int, ...) __MINGW_ASM_CRT_CALL(_wopen)
    __attribute__((__warning__("_wopen(..._O_CREAT...): missing argument")));

__mingw_bos_extern_ovr int _wopen(const wchar_t *__filename, int __flags, ...) {
  if (__builtin_va_arg_pack_len() > 1)
...
_CRTIMP int __cdecl __mingw_call__wsopen_warn_toomany(const wchar_t *, int, int,
                                                      ...)
    __MINGW_ASM_CRT_CALL(_wsopen)
        __attribute__((__warning__("_wsopen(): too many arguments")));
_CRTIMP int __cdecl __mingw_call__wsopen_warn_missing(
    const wchar_t *, int, int, ...) __MINGW_ASM_CRT_CALL(_wsopen)
    __attribute__((__warning__("_wsopen(..._O_CREAT...): missing argument")));

__mingw_bos_extern_ovr int _wsopen(const wchar_t *__filename, int __flags,
                                   int __share, ...) {
  if (__builtin_va_arg_pack_len() > 1)
...
#ifndef NO_OLDNAMES
__mingw_bos_extern_ovr int open(const char *__filename, int __flags, ...) {
  return _open(__filename, __flags, __builtin_va_arg_pack());
}

__mingw_bos_extern_ovr int sopen(const char *__filename, int __flags,
                                 int __share, ...) {
