...
_CRTIMP int __cdecl _is_exception_typeof(
    const std::type_info &_Type, struct _EXCEPTION_POINTERS *_ExceptionPtr);
...
_CRTIMP unexpected_function __cdecl set_unexpected(
    unexpected_function _NewPtFunc);
...
_CRTIMP _se_translator_function __cdecl _set_se_translator(
    _se_translator_function _NewPtFunc);
