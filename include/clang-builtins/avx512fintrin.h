...
#define _mm512_mask_reduce_operator(op)                                        \
  __m512i __t1 = (__m512i)__builtin_shufflevector((__v8di)__V, (__v8di)__V, 4, \
                                                  5, 6, 7, 0, 1, 2, 3);        \
  __m512i __t2 = _mm512_##op(__V, __t1);                                       \
  __m512i __t3 = (__m512i)__builtin_shufflevector((__v8di)__t2, (__v8di)__t2,  \
                                                  2, 3, 0, 1, 6, 7, 4, 5);     \
...
#define _mm512_mask_reduce_operator(op)                                       \
  ...
  __m128i __t7 = (__m128i)__builtin_shufflevector((__v4si)__t6, (__v4si)__t6, \
                                                  2, 3, 0, 1);                \
